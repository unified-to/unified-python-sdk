...
with UnifiedTo(
    ...
    res = unified_to.storage.create_storage_file2(request={
        "storage_file": {},
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.storage.get_storage_file2(request={
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.storage.list_storage_files2(request={
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.storage.patch_storage_file2(request={
        "storage_file": {},
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.storage.remove_storage_file2(request={
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.storage.update_storage_file2(request={
        "storage_file": {},
        "connection_id": "<id>",
        "id": "<id>",
    })
