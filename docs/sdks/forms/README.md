...
with UnifiedTo(
    ...
    res = unified_to.forms.create_forms_form(request={
        "forms_form": {
            ...
            "fields": [
                {
                    ...
                    "updated_at": parse_datetime("2025-04-13T03:46:38.973Z"),
                },
                {
                    "created_at": parse_datetime("2023-10-05T21:34:29.094Z"),
                    ...
                    "order": 1.0,
                    "type": shared.FormFieldType.TEXTAREA,
                    "updated_at": parse_datetime("2024-08-24T03:14:44.606Z"),
                },
                {
                    "choices": [
                        "vallum",
                    ...
                    "updated_at": parse_datetime("2024-02-22T10:54:34.556Z"),
                },
                {
                    "created_at": parse_datetime("2023-10-05T21:34:29.094Z"),
                    ...
                    "order": 3.0,
                    "type": shared.FormFieldType.TEXTAREA,
                    "updated_at": parse_datetime("2024-11-16T01:00:42.306Z"),
                },
            ],
            ...
            "updated_at": parse_datetime("2024-08-15T23:57:49.404Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.forms.get_forms_form(request={
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.forms.get_forms_submission(request={
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.forms.list_forms_forms(request={
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.forms.list_forms_submissions(request={
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.forms.patch_forms_form(request={
        "forms_form": {
            ...
            "fields": [
                {
                    ...
                    "order": 0.0,
                    "type": shared.FormFieldType.TEXTAREA,
                    "updated_at": parse_datetime("2025-04-13T03:46:38.979Z"),
                },
                {
                    "created_at": parse_datetime("2023-10-05T21:34:29.094Z"),
                    "id": "82b263f9-2d16-4cdf-8e99-d05ba46ce817",
                    ...
                    "order": 1.0,
                    "type": shared.FormFieldType.TEXTAREA,
                    "updated_at": parse_datetime("2024-08-24T03:14:44.610Z"),
                },
                {
                    "choices": [
                        "vallum",
                    ...
                    "order": 2.0,
                    "type": shared.FormFieldType.MULTIPLE_SELECT,
                    "updated_at": parse_datetime("2024-02-22T10:54:34.558Z"),
                },
                {
                    "created_at": parse_datetime("2023-10-05T21:34:29.094Z"),
                    "description": "Sequi antea delectatio.",
                    ...
                    "order": 3.0,
                    "type": shared.FormFieldType.TEXTAREA,
                    "updated_at": parse_datetime("2024-11-16T01:00:42.311Z"),
                },
            ],
            "has_multiple_submissions": False,
            "has_progress_bar": False,
            ...
            "published_url": "https://impartial-institute.org/",
            "response_count": 423.0,
            "updated_at": parse_datetime("2024-08-15T23:57:49.408Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.forms.remove_forms_form(request={
        "connection_id": "<id>",
        "id": "<id>",
    })
