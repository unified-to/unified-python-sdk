...
with UnifiedTo(
    ...
    res = unified_to.database.create_datastore_database(request={
        "datastore_database": {
            ...
            "id": "9763c337-4f9b-414c-848f-c3fc13260c6e",
            "is_active": True,
            "name": "Rau - O'Reilly",
            "password": "iYLhYwOHm0NLDvI",
            "region": "France",
            "updated_at": parse_datetime("2023-06-12T15:50:42.088Z"),
...
with UnifiedTo(
    ...
    res = unified_to.database.patch_datastore_database(request={
        "datastore_database": {
            "created_at": parse_datetime("2019-03-05T14:31:00.223Z"),
            "description": "Substantia tantillus coniuratio repellat coerceo amet vito vorago.",
            "id": "7fe024ca-9c51-4229-aa43-7d5f9da33569",
            "is_active": True,
            "name": "Rau - O'Reilly",
            "password": "iYLhYwOHm0NLDvI",
            "region": "France",
            "updated_at": parse_datetime("2023-06-12T15:50:42.093Z"),
            "web_url": "https://optimal-signature.name",
        },
        "connection_id": "<id>",
        "id": "<id>",
