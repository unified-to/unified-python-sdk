...
with UnifiedTo(
    ...
    res = unified_to.database.create_datastore_database(request={
        "datastore_database": {
            ...
            "id": "3eeb61cf-8f47-465f-a379-d06aca9495b4",
            "is_active": True,
            "name": "Rau - O'Reilly",
            "password": "iYLhYwOHm0NLDvI",
            "region": "France",
            "updated_at": parse_datetime("2023-06-12T21:03:34.472Z"),
...
with UnifiedTo(
    ...
    res = unified_to.database.patch_datastore_database(request={
        "datastore_database": {
            "created_at": parse_datetime("2019-03-05T14:31:00.223Z"),
            "description": "Substantia tantillus coniuratio repellat coerceo amet vito vorago.",
            "id": "d7ccd53c-fddb-4851-b2ac-b15caed1bd5c",
            "is_active": True,
            "name": "Rau - O'Reilly",
            "password": "iYLhYwOHm0NLDvI",
            "region": "France",
            "updated_at": parse_datetime("2023-06-12T21:03:34.477Z"),
            "web_url": "https://optimal-signature.name",
        },
        "connection_id": "<id>",
        "id": "<id>",
