...
with UnifiedTo(
    ...
    res = unified_to.kms.create_kms_comment(request={
        "kms_comment": {
            ...
            "id": "f2684603-ee46-4aa8-80ec-4a07d3c3ae1d",
            "type": shared.KmsCommentType.PAGE,
            "updated_at": parse_datetime("2023-11-16T14:59:19.180Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.kms.create_kms_page(request={
        "kms_page": {
            ...
            "has_children": True,
            "id": "fb7ec6e4-c3a4-4255-8bf2-36c69840a206",
            "is_active": True,
            "metadata": [],
            "title": "even minister extract",
            "type": shared.KmsPageType.HTML,
            "updated_at": parse_datetime("2025-09-11T13:40:48.688Z"),
...
with UnifiedTo(
    ...
    res = unified_to.kms.patch_kms_comment(request={
        "kms_comment": {
            ...
            "content_type": shared.ContentType.HTML,
            "created_at": parse_datetime("2022-08-26T14:40:49.732Z"),
            "id": "f6a3c333-2325-4d16-83d3-fe1b8ead8cf7",
            "type": shared.KmsCommentType.PAGE,
            "updated_at": parse_datetime("2023-11-16T14:59:19.183Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.kms.patch_kms_page(request={
        "kms_page": {
            ...
            "download_url": "https://agitated-validity.info",
            "has_children": True,
            "id": "f8857f1f-711a-4d62-bee8-b016804a9b73",
            "is_active": True,
            "metadata": [],
            "title": "even minister extract",
            "type": shared.KmsPageType.HTML,
            "updated_at": parse_datetime("2025-09-11T13:40:48.701Z"),
            "web_url": "https://another-petticoat.info",
        },
        "connection_id": "<id>",
        "id": "<id>",
