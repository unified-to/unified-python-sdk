...
with UnifiedTo(
    ...
    res = unified_to.kms.create_kms_comment(request={
        "kms_comment": {
            ...
            "id": "05c21ada-23b3-4982-a60b-3838774f35dc",
            "type": shared.KmsCommentType.PAGE,
            "updated_at": parse_datetime("2023-11-16T17:45:40.664Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.kms.create_kms_space(request={
        "kms_space": {
            ...
            "description": "Acer.",
            "id": "de739d40-40ba-4c6b-a73e-78742fd99551",
            "is_active": False,
            "name": "into nor afore",
            "updated_at": parse_datetime("2025-12-04T17:00:44.000Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.kms.patch_kms_comment(request={
        "kms_comment": {
            ...
            "content_type": shared.ContentType.HTML,
            "created_at": parse_datetime("2022-08-26T14:40:49.732Z"),
            "id": "eaf0fd86-608f-4c49-98b2-95576d362543",
            "type": shared.KmsCommentType.PAGE,
            "updated_at": parse_datetime("2023-11-16T17:45:40.667Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.kms.patch_kms_space(request={
        "kms_space": {
            "created_at": parse_datetime("2022-10-31T00:56:54.246Z"),
            "description": "Acer.",
            "id": "7b894f99-bc4e-4775-bc0a-9115303e47ab",
            "is_active": False,
            "name": "into nor afore",
            "updated_at": parse_datetime("2025-12-04T17:00:44.004Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
