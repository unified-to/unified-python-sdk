...
with UnifiedTo(
    ...
    res = unified_to.paymentterm.create_accounting_paymentterm(request={
        "accounting_paymentterm": {
            ...
            "id": "99ffcec4-46cb-431c-96c8-c6fcb9d51288",
            "is_active": False,
            "metadata": [],
            "name": "Net 30",
            "type": shared.AccountingPaymenttermType.NET_15,
            "updated_at": parse_datetime("2025-12-12T06:05:16.527Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.paymentterm.patch_accounting_paymentterm(request={
        "accounting_paymentterm": {
            ...
            "due_days": 57.0,
            "due_next_month_days": 9.0,
            "id": "d4f9a147-86b6-4b4e-8e39-ff8011ffcf83",
            "is_active": False,
            "metadata": [],
            "name": "Net 30",
            "type": shared.AccountingPaymenttermType.NET_15,
            "updated_at": parse_datetime("2025-12-12T06:05:16.542Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
