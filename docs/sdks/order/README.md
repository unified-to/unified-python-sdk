...
with UnifiedTo(
    ...
    res = unified_to.order.create_accounting_order(request={
        "accounting_order": {
            ...
            "currency": "USD",
            "id": "ad527401-1ece-4c32-9585-ad72d7c919b3",
            "lineitems": [],
            "metadata": [],
            "posted_at": parse_datetime("2022-04-05T05:30:15.285Z"),
            "shipping_address": {
            ...
            "updated_at": parse_datetime("2021-06-18T00:52:54.516Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.order.patch_accounting_order(request={
        "accounting_order": {
            ...
            "created_at": parse_datetime("2020-11-20T03:46:49.837Z"),
            "currency": "USD",
            "id": "452a2417-721c-4697-85db-0a4f6dbe29a2",
            "lineitems": [],
            "metadata": [],
            "posted_at": parse_datetime("2022-04-05T05:30:15.298Z"),
            "shipping_address": {
                "address1": "9745 Betty Shore",
                "city": "South Alainaland",
                "country_code": "US",
            ...
            "total_amount": 0.0,
            "type": shared.AccountingOrderType.PURCHASE,
            "updated_at": parse_datetime("2021-06-18T00:52:54.521Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
