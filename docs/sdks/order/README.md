...
with UnifiedTo(
    ...
    res = unified_to.order.create_assessment_order(request={
        "assessment_order": {
            ...
            "id": "76f613f1-5f4e-4d87-8ef4-41a07e7d0aa5",
            "parameters": [],
            "profile_addresses": [],
            ...
            "updated_at": parse_datetime("2023-01-17T10:16:03.961Z"),
            "workspace_id": "<id>",
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.order.patch_assessment_order(request={
        "assessment_order": {
            "connection_id": "<id>",
            "created_at": parse_datetime("2021-09-18T10:33:57.803Z"),
            "id": "ae235ab6-066e-4915-95b1-2a151c9d9e15",
            "parameters": [],
            "profile_addresses": [],
            "profile_date_of_birth": "1989-07-22T16:18:37.650Z",
            "profile_emails": [
            ...
            "status": shared.AssessmentOrderStatus.REJECTED,
            "target_url": "https://cautious-turret.info",
            "updated_at": parse_datetime("2023-01-17T10:16:03.969Z"),
            "workspace_id": "<id>",
        },
        "connection_id": "<id>",
        "id": "<id>",
