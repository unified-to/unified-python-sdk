...
req = operations.GetAtsConnectionIDScorecardRequest(
    ...
    query='architecto',
    sort='aliquam',
    updated_gte=dateutil.parser.parse('2022-07-12').date(),
)
...
req = operations.PatchAtsConnectionIDScorecardIDRequest(
    ats_scorecard=shared.AtsScorecard(
        ...
        created_at=dateutil.parser.parse('2022-07-22').date(),
        ...
        updated_at=dateutil.parser.parse('2021-06-03').date(),
    ),
    connection_id='dolor',
...
req = operations.PostAtsConnectionIDScorecardRequest(
    ats_scorecard=shared.AtsScorecard(
        ...
        created_at=dateutil.parser.parse('2022-04-19').date(),
        ...
        raw=shared.PropertyAtsScorecardRaw(),
        recommendation=shared.AtsScorecardRecommendation.DEFINITELY_NO,
        updated_at=dateutil.parser.parse('2022-09-13').date(),
    ),
...
req = operations.PutAtsConnectionIDScorecardIDRequest(
    ats_scorecard=shared.AtsScorecard(
        application_id='hic',
        candidate_id='error',
        created_at=dateutil.parser.parse('2020-02-11').date(),
