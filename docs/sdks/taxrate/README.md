...
with UnifiedTo(
    ...
    res = unified_to.taxrate.create_accounting_taxrate(request={
        "accounting_taxrate": {
            ...
            "id": "3f13e77f-745f-4952-8af5-eb31b96c84cd",
            "is_active": False,
            "metadata": [],
            "name": "cogo",
            "rate": 1.0,
            "updated_at": parse_datetime("2025-11-05T03:21:12.858Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.taxrate.patch_accounting_taxrate(request={
        "accounting_taxrate": {
            "created_at": parse_datetime("2020-01-04T10:37:56.894Z"),
            "description": "Nemo atrox tricesimus creator aranea.",
            "id": "439fce5d-ac5b-46f5-9ad7-51223794f11a",
            "is_active": False,
            "metadata": [],
            "name": "cogo",
            "rate": 1.0,
            "updated_at": parse_datetime("2025-11-05T03:21:12.873Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
