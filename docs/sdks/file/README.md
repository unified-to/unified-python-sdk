...
req = operations.GetCrmConnectionIDFileRequest(
    ...
    query='adipisci',
    sort='explicabo',
    updated_gte=dateutil.parser.parse('2022-01-22').date(),
)
...
req = operations.PatchCrmConnectionIDFileIDRequest(
    crm_file=shared.CrmFile(
        ...
        created_at=dateutil.parser.parse('2020-08-02').date(),
        deal_id='dolore',
        ...
        updated_at=dateutil.parser.parse('2022-12-09').date(),
        user_id='saepe',
    ),
...
req = operations.PostCrmConnectionIDFileRequest(
    crm_file=shared.CrmFile(
        ...
        contact_id='eos',
        created_at=dateutil.parser.parse('2022-10-08').date(),
        deal_id='nobis',
        description='quos',
        file_name='provident',
        file_size=4099.18,
...
req = operations.PutCrmConnectionIDFileIDRequest(
    crm_file=shared.CrmFile(
        ...
        company_id='commodi',
        contact_id='magni',
        created_at=dateutil.parser.parse('2022-05-23').date(),
        deal_id='aut',
        ...
        lead_id='beatae',
        raw=shared.PropertyCrmFileRaw(),
        updated_at=dateutil.parser.parse('2021-10-17').date(),
        user_id='ex',
    ),
    connection_id='harum',
