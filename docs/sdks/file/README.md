...
with UnifiedTo(
    ...
    res = unified_to.file.create_storage_file(request={
        "storage_file": {
            ...
            "id": "e21d67dd-a021-423a-bcc1-1ff0764566b3",
            "mime_type": "FOLDER",
            "name": "softly.tiff",
            "references": [
                {
            ...
            "updated_at": parse_datetime("2023-01-27T18:05:36.893Z"),
            "version": "1",
...
with UnifiedTo(
    ...
    res = unified_to.file.patch_storage_file(request={
        "storage_file": {
            ...
            "download_url": "https://stingy-casement.name/",
            "hash": "fe6a659e-75cd-4079-9b76-351f9af2205a",
            "id": "154ddfa8-27f8-4e14-aac9-6d94f83b72a9",
            "mime_type": "FOLDER",
            "name": "softly.tiff",
            "references": [
                {
            ...
            "type": shared.StorageFileType.FILE,
            "updated_at": parse_datetime("2023-01-27T18:05:36.898Z"),
            "version": "1",
            "web_url": "https://sandy-distinction.info/",
        },
        "connection_id": "<id>",
