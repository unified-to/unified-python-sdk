...
with UnifiedTo(
    ...
    res = unified_to.member.create_martech_member(request={
        "marketing_member": {
            ...
            "first_name": "Jude",
            "id": "8eff81f7-8747-4cf3-918f-37392212804a",
            "last_name": "Leffler",
            "name": "Jude Leffler",
            ...
            "updated_at": parse_datetime("2025-06-15T21:06:38.371Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.member.patch_martech_member(request={
        "marketing_member": {
            ...
            "first_name": "Jude",
            "id": "a3b3cea3-caf2-4868-8658-cecff7594d97",
            "last_name": "Leffler",
            "name": "Jude Leffler",
            "status": shared.MarketingMemberStatus.UNSUBSCRIBED,
            "tags": [
            ...
            "updated_at": parse_datetime("2025-06-15T21:06:38.377Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
