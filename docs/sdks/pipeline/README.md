...
with UnifiedTo(
    ...
    res = unified_to.pipeline.create_crm_pipeline(request={
        "crm_pipeline": {
            ...
            "display_order": 8.0,
            "id": "57f4a8d5-80bd-449f-93a3-b9628254bf34",
            "is_active": True,
            ...
            "stages": [
                {
                    ...
                    "display_order": 72.0,
                    "id": "4b447755-06e5-4429-9d60-1f5beb1628ab",
                    "is_closed": True,
                    "name": "Veniam.",
                    "updated_at": parse_datetime("2025-09-17T02:19:11.460Z"),
                },
            ],
            "updated_at": parse_datetime("2025-10-08T07:44:54.332Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.pipeline.patch_crm_pipeline(request={
        "crm_pipeline": {
            ...
            "deal_probability": 99.0,
            "display_order": 8.0,
            "id": "37c1c2bb-9a6d-44a1-b848-7164f3007fa6",
            "is_active": True,
            "name": "Small Steel Bacon",
            "stages": [
                {
                    ...
                    "deal_probability": 84.0,
                    "display_order": 72.0,
                    "id": "3e557d99-d2e6-4eee-90e4-e290b70405e3",
                    "is_closed": True,
                    "name": "Veniam.",
                    "updated_at": parse_datetime("2025-09-17T02:19:11.465Z"),
                },
            ],
            "updated_at": parse_datetime("2025-10-08T07:44:54.337Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
