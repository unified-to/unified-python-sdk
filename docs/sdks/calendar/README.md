...
with UnifiedTo(
    ...
    res = unified_to.calendar.create_calendar_calendar(request={
        "calendar_calendar": {
            ...
            "id": "1538aa8e-17b0-4a65-b487-f9d145895efc",
            "is_primary": False,
            "name": "Acer supra vallum suasoria thesaurus omnis condico cognomen accendo vehemens.",
            "timezone": "America/Dawson_Creek",
            "updated_at": parse_datetime("2023-03-13T03:06:28.873Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.calendar.create_calendar_event(request={
        "calendar_event": {
            ...
            "end_at": "2020-05-20T18:14:12.867Z",
            "id": "39fe8513-cb52-4a17-999e-ca6c8ab5631c",
            "is_all_day": False,
            "is_free": False,
            "is_private": False,
            ...
            "recurrence": [
                {
                    "count": 8.0,
                    "end_at": parse_datetime("2025-12-26T14:50:41.775Z"),
                    "excluded_dates": [
                        "2025-10-01T06:40:12.862Z",
                        "2023-10-09T17:38:08.189Z",
                        "2024-02-15T19:11:55.151Z",
                    ],
                    "frequency": shared.CalendarEventRecurrenceFrequency.MONTHLY,
                    "included_dates": [
                        "2021-02-17T00:03:24.165Z",
                    ],
                    "interval": 4.0,
                    "on_days": [
                ...
                {
                    "count": 9.0,
                    "end_at": parse_datetime("2025-04-30T13:17:30.254Z"),
                    "excluded_dates": [
                        "2020-04-29T01:40:20.225Z",
                    ],
                    "frequency": shared.CalendarEventRecurrenceFrequency.DAILY,
                    "included_dates": [
                        "2020-09-11T03:59:56.961Z",
                        "2021-11-29T04:27:46.550Z",
                        "2019-12-22T18:35:50.499Z",
                    ],
                    "interval": 1.0,
                    "on_days": [
                ...
                {
                    "count": 1.0,
                    "end_at": parse_datetime("2020-11-04T19:31:11.448Z"),
                    "excluded_dates": [
                        "2023-01-12T02:01:17.896Z",
                        "2021-09-07T16:04:04.652Z",
                    ],
                    "frequency": shared.CalendarEventRecurrenceFrequency.WEEKLY,
                    "included_dates": [
                        "2024-08-31T17:32:15.085Z",
                    ],
                    "interval": 9.0,
                    "on_days": [
                        shared.PropertyCalendarEventRecurrenceOnDays.TU,
            ...
            "recurring_event_id": "432949e9-0ef9-4d6b-8558-601d708d6843",
            "send_notifications": False,
            "start_at": "2020-05-20T09:07:15.193Z",
            "status": shared.CalendarEventStatus.CONFIRMED,
            "subject": "Sunt spargo tepidus bestia vigor credo coadunatio appello.",
            "timezone": "Asia/Bangkok",
            "updated_at": "2020-06-26T05:57:06.958Z",
...
with UnifiedTo(
    ...
    res = unified_to.calendar.patch_calendar_calendar(request={
        "calendar_calendar": {
            "created_at": parse_datetime("2020-01-09T23:11:34.147Z"),
            "description": "Socius catena auxilium.",
            "id": "24a6691d-cca4-460e-b371-3f8093a9922a",
            "is_primary": False,
            "name": "Acer supra vallum suasoria thesaurus omnis condico cognomen accendo vehemens.",
            "timezone": "America/Dawson_Creek",
            "updated_at": parse_datetime("2023-03-13T03:06:28.875Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.calendar.patch_calendar_event(request={
        "calendar_event": {
            ...
            "conference": [],
            "created_at": "2019-08-04T14:33:51.814Z",
            "end_at": "2020-05-20T18:14:12.870Z",
            "id": "87128b0a-6275-476c-bfe2-00a552d3f6c6",
            "is_all_day": False,
            "is_free": False,
            "is_private": False,
            "location": "621 Boehm Prairie",
            ...
            "recurrence": [
                {
                    "count": 8.0,
                    "end_at": parse_datetime("2025-12-26T14:50:41.799Z"),
                    "excluded_dates": [
                        "2025-10-01T06:40:12.884Z",
                        "2023-10-09T17:38:08.204Z",
                        "2024-02-15T19:11:55.168Z",
                    ],
                    "frequency": shared.CalendarEventRecurrenceFrequency.MONTHLY,
                    "included_dates": [
                        "2021-02-17T00:03:24.171Z",
                    ],
                    "interval": 4.0,
                    "on_days": [
                        shared.PropertyCalendarEventRecurrenceOnDays.TH,
                ...
                {
                    "count": 9.0,
                    "end_at": parse_datetime("2025-04-30T13:17:30.274Z"),
                    "excluded_dates": [
                        "2020-04-29T01:40:20.228Z",
                    ],
                    "frequency": shared.CalendarEventRecurrenceFrequency.DAILY,
                    "included_dates": [
                        "2020-09-11T03:59:56.965Z",
                        "2021-11-29T04:27:46.559Z",
                        "2019-12-22T18:35:50.500Z",
                    ],
                    "interval": 1.0,
                    "on_days": [
                        shared.PropertyCalendarEventRecurrenceOnDays.WE,
                ...
                {
                    "count": 1.0,
                    "end_at": parse_datetime("2020-11-04T19:31:11.452Z"),
                    "excluded_dates": [
                        "2023-01-12T02:01:17.909Z",
                        "2021-09-07T16:04:04.659Z",
                    ],
                    "frequency": shared.CalendarEventRecurrenceFrequency.WEEKLY,
                    "included_dates": [
                        "2024-08-31T17:32:15.104Z",
                    ],
                    "interval": 9.0,
                    "on_days": [
                        shared.PropertyCalendarEventRecurrenceOnDays.TU,
            ...
            "recurring_event_id": "0bf4a380-3c5d-402d-9ac6-254fc3a499ee",
            "send_notifications": False,
            "start_at": "2020-05-20T09:07:15.196Z",
            "status": shared.CalendarEventStatus.CONFIRMED,
            "subject": "Sunt spargo tepidus bestia vigor credo coadunatio appello.",
            "timezone": "Asia/Bangkok",
            "updated_at": "2020-06-26T05:57:06.961Z",
            "web_url": "https://another-pinstripe.com",
        },
        "connection_id": "<id>",
        "id": "<id>",
