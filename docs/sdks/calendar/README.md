...
with UnifiedTo(
    ...
    res = unified_to.calendar.create_calendar_calendar(request={
        "calendar_calendar": {
            ...
            "updated_at": parse_datetime("2023-03-12T12:08:46.702Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.calendar.create_calendar_event(request={
        "calendar_event": {
            ...
            "end_at": "2020-05-20T14:42:59.889Z",
            ...
            "recurrence": [
                {
                    "count": 8.0,
                    "end_at": parse_datetime("2025-12-25T10:30:12.078Z"),
                    "excluded_dates": [
                ...
                {
                    "count": 9.0,
                    "end_at": parse_datetime("2025-04-29T11:51:45.833Z"),
                    "excluded_dates": [
                ...
                {
                    "count": 1.0,
                    "end_at": parse_datetime("2020-11-04T13:57:38.419Z"),
                    "excluded_dates": [
            ...
            "recurring_event_id": "a9d9402f-2b05-463c-a299-01f36c55f0a9",
            "send_notifications": False,
            "start_at": "2020-05-20T05:36:18.805Z",
            "status": shared.CalendarEventStatus.CONFIRMED,
            "subject": "Sunt spargo tepidus bestia vigor credo coadunatio appello.",
            "timezone": "Asia/Bangkok",
            "updated_at": "2020-06-26T01:59:20.292Z",
...
with UnifiedTo(
    ...
    res = unified_to.calendar.patch_calendar_calendar(request={
        "calendar_calendar": {
            ...
            "name": "Acer supra vallum suasoria thesaurus omnis condico cognomen accendo vehemens.",
            "timezone": "America/Dawson_Creek",
            "updated_at": parse_datetime("2023-03-12T12:08:46.705Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.calendar.patch_calendar_event(request={
        "calendar_event": {
            ...
            "conference": [],
            "created_at": "2019-08-04T14:33:51.814Z",
            "end_at": "2020-05-20T14:42:59.895Z",
            ...
            "recurrence": [
                {
                    "count": 8.0,
                    "end_at": parse_datetime("2025-12-25T10:30:12.122Z"),
                    "excluded_dates": [
                ...
                {
                    "count": 9.0,
                    "end_at": parse_datetime("2025-04-29T11:51:45.873Z"),
                    "excluded_dates": [
                ...
                {
                    "count": 1.0,
                    "end_at": parse_datetime("2020-11-04T13:57:38.428Z"),
                    "excluded_dates": [
            ...
            "recurring_event_id": "ad61f948-2c46-4525-b8eb-fd2fc3e80bc7",
            "send_notifications": False,
            "start_at": "2020-05-20T05:36:18.811Z",
            "status": shared.CalendarEventStatus.CONFIRMED,
            "subject": "Sunt spargo tepidus bestia vigor credo coadunatio appello.",
            "timezone": "Asia/Bangkok",
            "updated_at": "2020-06-26T01:59:20.298Z",
            "web_url": "https://another-pinstripe.com",
        },
        "connection_id": "<id>",
        "id": "<id>",
