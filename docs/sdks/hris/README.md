...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_attendance(request={
        "hris_attendance": {
            ...
            "approved_at": parse_datetime("2021-08-13T10:37:55.766Z"),
            "breaks": [
                {
                    "duration_minutes": 12.0,
                    "end_at": parse_datetime("2023-10-23T02:00:25.579Z"),
                    "id": "d60a1001-5a8a-4991-8c21-f4da6036cc87",
                    "is_paid": True,
                    "name": "Lunch",
                    "start_at": parse_datetime("2023-10-16T06:21:50.732Z"),
                },
            ],
            ...
            "employee_user_id": "<id>",
            "end_at": parse_datetime("2024-04-06T15:33:47.979Z"),
            "hourly_rate": 53.0,
            "hours": 10.0,
            "id": "fec3216d-df3b-4e51-90f6-dedb81e89342",
            "job_name": "Global Creative Supervisor",
            "non_cash_tips_amount": 54.0,
            "start_at": parse_datetime("2021-11-09T11:31:11.587Z"),
            "status": shared.HrisAttendanceStatus.CLOSED,
            "timezone": "America/Atikokan",
            "updated_at": parse_datetime("2022-01-17T03:19:38.951Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_bankaccount(request={
        "hris_bankaccount": {
            ...
            "id": "a3516f34-9336-4e6c-89b4-b15a52a387ec",
            "is_primary": False,
            "name": "Checking Account",
            "routing_number": "448650724",
            "updated_at": parse_datetime("2025-06-05T05:39:50.306Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_benefit(request={
        "hris_benefit": {
            ...
            "id": "8b32b37f-4d01-4664-a74f-c47ac3822568",
            "is_active": False,
            "name": "Frozen Wooden Ball",
            "tax": shared.Tax.PRE_TAX,
            "type": shared.HrisBenefitType.GARNISHMENT,
            "updated_at": parse_datetime("2023-03-06T20:45:33.631Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_company(request={
        "hris_company": {
            ...
            "id": "cce02aac-1494-4c07-b74a-3bcaf14ab2d7",
            "legal_name": "Schultz LLC",
            "name": "Gottlieb Group",
            "updated_at": parse_datetime("2026-09-06T19:24:54.141Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_device(request={
        "hris_device": {
            ...
            "has_screenlock": True,
            "id": "af3e715d-70e2-46d2-b996-0d44152db42c",
            "is_missing": False,
            ...
            "os": "monitor",
            "os_version": "1.12.16",
            "updated_at": parse_datetime("2023-05-21T13:19:00.267Z"),
            "version": "2.20.17",
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_employee(request={
        "hris_employee": {
            ...
            "has_mfa": True,
            "hired_at": parse_datetime("2023-05-11T03:53:15.152Z"),
            "id": "8b185b20-7dbe-48ef-a8c8-c83140a90eed",
            ...
            "metadata": [
                {
                    ...
                    "id": "6b50dd19-cdec-448f-8ce2-1e98da53c872",
                    "namespace": "custom",
            ...
            "updated_at": parse_datetime("2022-02-19T14:46:57.314Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_group(request={
        "hris_group": {
            ...
            "id": "e67b8f74-b470-430b-964e-b95e6b690f67",
            "is_active": False,
            "name": "Games",
            "type": shared.HrisGroupType.BUSINESS_UNIT,
            "updated_at": parse_datetime("2026-04-24T09:38:41.461Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_location(request={
        "hris_location": {
            ...
            "external_identifier": "f453c41f-5f25-44cc-8cdc-8e33a5b31a9c",
            "id": "6c11765c-9349-4d92-a5b0-5943f9cb851b",
            "is_active": True,
            "is_hq": False,
            "language_locale": "fr",
            "name": "adhuc",
            ...
            "updated_at": parse_datetime("2023-06-09T08:50:56.332Z"),
        },
        "connection_id": "<id>",
    })
    ...
    res = unified_to.hris.patch_hris_attendance(request={
        "hris_attendance": {
            ...
            "breaks": [
                {
                    "duration_minutes": 12.0,
                    "end_at": parse_datetime("2023-10-23T02:00:25.590Z"),
                    "id": "d60a1001-5a8a-4991-8c21-f4da6036cc87",
                    "is_paid": True,
                    "name": "Lunch",
                    "start_at": parse_datetime("2023-10-16T06:21:50.743Z"),
                },
            ],
            "created_at": parse_datetime("2021-08-10T19:43:18.452Z"),
            "currency": "UGX",
            "declared_tips_amount": 161.0,
            "employee_user_id": "<id>",
            "end_at": parse_datetime("2024-04-06T15:33:47.993Z"),
            "hourly_rate": 53.0,
            "hours": 10.0,
            "id": "b2360f22-cde1-41a5-9cea-b76990466cf3",
            "job_name": "Global Creative Supervisor",
            "non_cash_tips_amount": 54.0,
            "start_at": parse_datetime("2021-11-09T11:31:11.588Z"),
            "status": shared.HrisAttendanceStatus.CLOSED,
            "timezone": "America/Atikokan",
            "updated_at": parse_datetime("2022-01-17T03:19:38.954Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.patch_hris_bankaccount(request={
        "hris_bankaccount": {
            ...
            "bank_name": "Huel Group",
            "created_at": parse_datetime("2019-11-16T16:43:45.976Z"),
            "id": "ee0b7b15-c45b-4cad-ba3d-ae501748d719",
            "is_primary": False,
            "name": "Checking Account",
            "routing_number": "448650724",
            "updated_at": parse_datetime("2025-06-05T05:39:50.317Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.patch_hris_benefit(request={
        "hris_benefit": {
            ...
            "employer_contribution_type": shared.EmployerContributionType.PERCENTAGE,
            "frequency": shared.HrisBenefitFrequency.HOUR,
            "id": "7b6897d5-1178-4063-9d82-be1ed0beebce",
            "is_active": False,
            "name": "Frozen Wooden Ball",
            "tax": shared.Tax.PRE_TAX,
            "type": shared.HrisBenefitType.GARNISHMENT,
            "updated_at": parse_datetime("2023-03-06T20:45:33.638Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.patch_hris_company(request={
        "hris_company": {
            ...
            "created_at": parse_datetime("2021-05-02T22:27:38.970Z"),
            "id": "50181e51-b4bf-4da1-a86f-e9d457a25773",
            "legal_name": "Schultz LLC",
            "name": "Gottlieb Group",
            "updated_at": parse_datetime("2026-09-06T19:24:54.155Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.patch_hris_device(request={
        "hris_device": {
            ...
            "has_password_manager": True,
            "has_screenlock": True,
            "id": "5ca72f98-4e3a-4bc4-8d76-bfc94f272ecc",
            "is_missing": False,
            "manufacturer": "Sanford - Hamill",
            "model": "Refined",
            "name": "cross_contamination_if.rar",
            "os": "monitor",
            "os_version": "1.12.16",
            "updated_at": parse_datetime("2023-05-21T13:19:00.275Z"),
            "version": "2.20.17",
        },
        "connection_id": "<id>",
        "id": "<id>",
...
with UnifiedTo(
    ...
    res = unified_to.hris.patch_hris_employee(request={
        "hris_employee": {
            ...
            "gender": shared.HrisEmployeeGender.INTERSEX,
            "has_mfa": True,
            "hired_at": parse_datetime("2023-05-11T03:53:15.207Z"),
            "id": "a3db698c-6df7-4684-a87f-ebba77407059",
            "image_url": "https://loremflickr.com/3684/2116?lock=4686991638584456",
            "language_locale": "es",
            "last_name": "Prohaska",
            "locations": [],
            ...
            "metadata": [
                {
                    ...
                    "format_": shared.HrisMetadataFormat.TEXT,
                    "id": "a4f44f4f-e771-4d99-8542-ec1711248755",
                    "namespace": "custom",
                    "slug": "custom_property",
                    "value": "tenetur",
                },
            ...
            "timezone": "Africa/Harare",
            "title": "Investor Paradigm Liaison",
            "updated_at": parse_datetime("2022-02-19T14:46:57.350Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.patch_hris_group(request={
        "hris_group": {
            "created_at": parse_datetime("2023-11-01T13:13:40.714Z"),
            "description": "Absorbeo casso.",
            "id": "2c881674-f9e4-4cf7-bb1b-09837efdfdaa",
            "is_active": False,
            "name": "Games",
            "type": shared.HrisGroupType.BUSINESS_UNIT,
            "updated_at": parse_datetime("2026-04-24T09:38:41.471Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.patch_hris_location(request={
        "hris_location": {
            ...
            "currency": "MUR",
            "description": "Acervus caries.",
            "external_identifier": "83f19f90-c3ce-4617-9ba5-6babae37a9a0",
            "id": "7cc227c3-51b2-44b4-b67f-53bc5b23b44a",
            "is_active": True,
            "is_hq": False,
            "language_locale": "fr",
            "name": "adhuc",
            ...
            "timezone": "America/Guyana",
            "updated_at": parse_datetime("2023-06-09T08:50:56.340Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
