...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_bankaccount(request={
        "hris_bankaccount": {
            ...
            "id": "60d2ac8f-fe83-4695-90fb-eb1ef50c9018",
            "is_primary": False,
            "name": "Checking Account",
            "routing_number": "448650724",
            "updated_at": parse_datetime("2025-06-05T13:08:10.006Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_benefit(request={
        "hris_benefit": {
            ...
            "id": "f1aadc76-12b4-4651-b061-ad1ed2f3fe91",
            "is_active": False,
            "name": "Frozen Wooden Ball",
            "tax": shared.Tax.PRE_TAX,
            "type": shared.HrisBenefitType.GARNISHMENT,
            "updated_at": parse_datetime("2023-03-07T00:46:24.445Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_company(request={
        "hris_company": {
            ...
            "id": "fbdd7b53-e50e-4df9-963f-a384ed046902",
            "legal_name": "Schultz LLC",
            "name": "Gottlieb Group",
            "updated_at": parse_datetime("2026-09-07T04:33:54.360Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_deduction(request={
        "hris_deduction": {
            ...
            "end_at": parse_datetime("2026-05-24T04:53:48.202Z"),
            "frequency": shared.HrisDeductionFrequency.MONTH,
            "id": "fd2218bf-72b8-4254-a29b-e3240e91eb4e",
            "is_active": False,
            "notes": "Carmen desidero.",
            "start_at": parse_datetime("2025-02-19T04:40:09.947Z"),
            "type": shared.HrisDeductionType.FIXED,
            "updated_at": parse_datetime("2024-03-02T19:07:17.403Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_device(request={
        "hris_device": {
            ...
            "has_screenlock": True,
            "id": "78bdeb6e-7993-4787-bdcb-e018e016eac0",
            "is_missing": False,
            ...
            "os": "monitor",
            "os_version": "1.12.16",
            "updated_at": parse_datetime("2023-05-21T18:24:45.595Z"),
            "version": "2.20.17",
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_document(request={
        "hris_document": {
            ...
            "id": "5501f51c-87c6-4825-879b-fd54aca3ca81",
            "type": shared.HrisDocumentType.POLICY,
            "updated_at": parse_datetime("2025-09-18T01:21:29.796Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_employee(request={
        "hris_employee": {
            ...
            "has_mfa": True,
            "hired_at": parse_datetime("2023-05-11T08:40:52.335Z"),
            "id": "40fe95b7-4e27-4965-994b-e0bac5f0d33a",
            ...
            "metadata": [
                {
                    ...
                    "id": "b0f98b76-9bce-456d-b366-3c239b597b43",
                    "namespace": "custom",
            ...
            "updated_at": parse_datetime("2022-02-19T17:58:24.372Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_group(request={
        "hris_group": {
            ...
            "id": "ecdc59a9-9ed6-4be1-a045-8f8a4e64437e",
            "is_active": False,
            "name": "Games",
            "type": shared.HrisGroupType.BUSINESS_UNIT,
            "updated_at": parse_datetime("2026-04-24T17:33:39.892Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_taxonomy(request={
        "hris_taxonomy": {
            ...
            "updated_at": parse_datetime("2023-05-22T11:45:09.551Z"),
...
with UnifiedTo(
    ...
    res = unified_to.hris.create_hris_timeoff(request={
        "hris_timeoff": {
            "approved_at": parse_datetime("2022-02-20T23:26:23.174Z"),
            ...
            "end_at": parse_datetime("2024-12-08T10:04:44.588Z"),
            "id": "9aa20f58-7ae3-4963-84dc-1bf8a0d51da7",
            "is_paid": True,
            "original_type": "acerbitas ut",
            "reason": "verto",
            "start_at": parse_datetime("2023-08-23T18:55:26.256Z"),
            "status": shared.HrisTimeoffStatus.DENIED,
            "type": shared.HrisTimeoffType.IN_LIEU,
            "updated_at": parse_datetime("2022-07-08T00:22:13.413Z"),
            "user_id": "<id>",
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.patch_hris_bankaccount(request={
        "hris_bankaccount": {
            ...
            "bank_name": "Huel Group",
            "created_at": parse_datetime("2019-11-16T16:43:45.976Z"),
            "id": "253834f6-ad43-40c4-a8f3-ea424d969e78",
            "is_primary": False,
            "name": "Checking Account",
            "routing_number": "448650724",
            "updated_at": parse_datetime("2025-06-05T13:08:10.011Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.patch_hris_benefit(request={
        "hris_benefit": {
            ...
            "employer_contribution_type": shared.EmployerContributionType.PERCENTAGE,
            "frequency": shared.HrisBenefitFrequency.HOUR,
            "id": "f9acfcc7-e7ff-416d-a760-f53cf66cab87",
            "is_active": False,
            "name": "Frozen Wooden Ball",
            "tax": shared.Tax.PRE_TAX,
            "type": shared.HrisBenefitType.GARNISHMENT,
            "updated_at": parse_datetime("2023-03-07T00:46:24.450Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.patch_hris_company(request={
        "hris_company": {
            ...
            "created_at": parse_datetime("2021-05-02T22:27:38.970Z"),
            "id": "45eaca94-c2a8-4127-a695-426dd55cfd46",
            "legal_name": "Schultz LLC",
            "name": "Gottlieb Group",
            "updated_at": parse_datetime("2026-09-07T04:33:54.369Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.patch_hris_deduction(request={
        "hris_deduction": {
            ...
            "coverage_level": shared.HrisDeductionCoverageLevel.EMPLOYEE_ONLY,
            "created_at": parse_datetime("2020-02-05T01:46:31.384Z"),
            "end_at": parse_datetime("2026-05-24T04:53:48.211Z"),
            "frequency": shared.HrisDeductionFrequency.MONTH,
            "id": "46c901c8-33d0-49fb-bf16-9fe3d7572ac9",
            "is_active": False,
            "notes": "Carmen desidero.",
            "start_at": parse_datetime("2025-02-19T04:40:09.954Z"),
            "type": shared.HrisDeductionType.FIXED,
            "updated_at": parse_datetime("2024-03-02T19:07:17.408Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.patch_hris_device(request={
        "hris_device": {
            ...
            "has_password_manager": True,
            "has_screenlock": True,
            "id": "db195386-c884-4cb2-9456-8bf0523a1c40",
            "is_missing": False,
            "manufacturer": "Sanford - Hamill",
            "model": "Refined",
            "name": "cross_contamination_if.rar",
            "os": "monitor",
            "os_version": "1.12.16",
            "updated_at": parse_datetime("2023-05-21T18:24:45.599Z"),
            "version": "2.20.17",
        },
        "connection_id": "<id>",
        "id": "<id>",
...
with UnifiedTo(
    ...
    res = unified_to.hris.patch_hris_document(request={
        "hris_document": {
            ...
            "document_url": "https://sore-decision.biz/",
            "filename": "ridge_forager.xsl",
            "id": "d9581fb3-0aaa-412d-b8d5-2f50f2db1ed9",
            "type": shared.HrisDocumentType.POLICY,
            "updated_at": parse_datetime("2025-09-18T01:21:29.801Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.patch_hris_employee(request={
        "hris_employee": {
            ...
            "gender": shared.HrisEmployeeGender.INTERSEX,
            "has_mfa": True,
            "hired_at": parse_datetime("2023-05-11T08:40:52.374Z"),
            "id": "26600884-b7a8-4dc9-9fb9-a5c2bf4a27d2",
            "image_url": "https://loremflickr.com/3684/2116?lock=4686991638584456",
            "language_locale": "es",
            "last_name": "Prohaska",
            "locations": [],
            ...
            "metadata": [
                {
                    ...
                    "format_": shared.HrisMetadataFormat.TEXT,
                    "id": "f24f0f04-a9b4-43e2-8e36-1a07458d160a",
                    "namespace": "custom",
                    "slug": "custom_property",
                    "value": "tenetur",
                },
            ...
            "timezone": "Africa/Harare",
            "title": "Investor Paradigm Liaison",
            "updated_at": parse_datetime("2022-02-19T17:58:24.397Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.patch_hris_group(request={
        "hris_group": {
            "created_at": parse_datetime("2023-11-01T13:13:40.714Z"),
            "description": "Absorbeo casso.",
            "id": "70e7dff4-3bd4-4385-ba12-a30aeec19a88",
            "is_active": False,
            "name": "Games",
            "type": shared.HrisGroupType.BUSINESS_UNIT,
            "updated_at": parse_datetime("2026-04-24T17:33:39.900Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.hris.patch_hris_timeoff(request={
        "hris_timeoff": {
            "approved_at": parse_datetime("2022-02-20T23:26:23.175Z"),
            "comments": "Blandior ventus curiositas amplitudo.",
            "created_at": parse_datetime("2021-10-06T18:00:20.615Z"),
            "duration": 4.0,
            "duration_type": shared.DurationType.DAY,
            "end_at": parse_datetime("2024-12-08T10:04:44.594Z"),
            "id": "bbb79680-cad7-4c9a-a787-116a366f3646",
            "is_paid": True,
            "original_type": "acerbitas ut",
            "reason": "verto",
            "start_at": parse_datetime("2023-08-23T18:55:26.260Z"),
            "status": shared.HrisTimeoffStatus.DENIED,
            "type": shared.HrisTimeoffType.IN_LIEU,
            "updated_at": parse_datetime("2022-07-08T00:22:13.414Z"),
            "user_id": "<id>",
        },
        "connection_id": "<id>",
        "id": "<id>",
