...
with UnifiedTo(
    ...
    res = unified_to.vendorcredit.create_accounting_vendorcredit(request={
        "accounting_vendorcredit": {
            ...
            "id": "b6823602-0b54-43b4-aed9-7f713d059bca",
            "lineitems": [],
            "metadata": [],
            "notes": "Conatus cruciamentum decor avaritia tantum.",
            "posted_at": parse_datetime("2023-09-28T19:41:28.758Z"),
            "status": shared.AccountingVendorcreditStatus.SUBMITTED,
            "total_amount": 0.0,
            "updated_at": parse_datetime("2023-11-26T18:36:43.880Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.vendorcredit.patch_accounting_vendorcredit(request={
        "accounting_vendorcredit": {
            ...
            "currency": "KGS",
            "due_at": parse_datetime("2023-05-06T20:38:46.775Z"),
            "id": "7ae560d6-73a0-4e00-abb7-9718c6933434",
            "lineitems": [],
            "metadata": [],
            "notes": "Conatus cruciamentum decor avaritia tantum.",
            "posted_at": parse_datetime("2023-09-28T19:41:28.763Z"),
            "status": shared.AccountingVendorcreditStatus.SUBMITTED,
            "total_amount": 0.0,
            "updated_at": parse_datetime("2023-11-26T18:36:43.887Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
