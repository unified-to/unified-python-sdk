...
with UnifiedTo(
    ...
    res = unified_to.martech.create_martech_list(request={
        "marketing_list": {
            ...
            "description": "Currus.",
            "id": "5fca6284-e69d-40ea-b261-bf955728d127",
            "is_active": True,
            "language": "it",
            "name": "Annette Nolan",
            ...
            "updated_at": parse_datetime("2022-08-31T01:40:59.617Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.martech.create_martech_member(request={
        "marketing_member": {
            ...
            "first_name": "Jude",
            "id": "19a9b305-6413-4d7c-b697-a5b36897795c",
            "last_name": "Leffler",
            "name": "Jude Leffler",
            ...
            "updated_at": parse_datetime("2025-06-16T03:41:54.922Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.martech.patch_martech_list(request={
        "marketing_list": {
            ...
            "created_at": parse_datetime("2019-09-18T02:01:36.950Z"),
            "description": "Currus.",
            "id": "c4d623c4-c729-4988-b31a-58b0b637d991",
            "is_active": True,
            "language": "it",
            "name": "Annette Nolan",
            "sender_company": "Hickle - Homenick",
            ...
            "sender_phone": "896-328-1153 x4957",
            "subject": "Tenetur thymum circumvenio triumphus celo.",
            "updated_at": parse_datetime("2022-08-31T01:40:59.627Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.martech.patch_martech_member(request={
        "marketing_member": {
            ...
            "first_name": "Jude",
            "id": "f897c195-45b8-4fd8-8441-7942a1ce2505",
            "last_name": "Leffler",
            "name": "Jude Leffler",
            "status": shared.MarketingMemberStatus.UNSUBSCRIBED,
            "tags": [
            ...
            "updated_at": parse_datetime("2025-06-16T03:41:54.930Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
