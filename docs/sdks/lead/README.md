...
with UnifiedTo(
    ...
    res = unified_to.lead.create_crm_lead(request={
        "crm_lead": {
            ...
            "first_name": "Velda",
            "id": "16784f30-32e6-4774-844a-e66b5bb4589f",
            "is_active": True,
            "last_name": "Sporer",
            "link_urls": [
            ...
            "metadata": [
                {
                    ...
                    "id": "958e1484-40c5-4d0d-99ed-d393e92ec455",
                    "namespace": "custom",
            ...
            "updated_at": parse_datetime("2020-05-15T04:02:57.602Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.lead.patch_crm_lead(request={
        "crm_lead": {
            ...
            "first_name": "Velda",
            "id": "419d886c-6e5c-4bb0-abab-70c17a4692e5",
            "is_active": True,
            "last_name": "Sporer",
            "link_urls": [
                "https://classic-sightseeing.com/",
            ...
            "metadata": [
                {
                    ...
                    "format_": shared.CrmMetadataFormat.TEXT,
                    "id": "fe94e848-07c9-4c57-b2d9-e4be71b8cd1f",
                    "namespace": "custom",
                    "slug": "custom_property",
                    "value": "sublime",
                },
            ...
            "updated_at": parse_datetime("2020-05-15T04:02:57.604Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
