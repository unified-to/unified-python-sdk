...
with UnifiedTo(
    ...
    res = unified_to.ads.create_ads_ad(request={
        "ads_ad": {
            ...
            "id": "a3a51417-5249-48a8-b981-66be5bb99ff1",
            "name": "Hermiston Group",
            "status": shared.AdsAdStatus.ARCHIVED,
            "updated_at": parse_datetime("2024-06-05T11:45:25.416Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.ads.create_ads_asset(request={
        "ads_asset": {
            ...
            "height": 400.0,
            "id": "0d4ff2d8-5719-49c2-af2e-37f125293f5e",
            "mime_type": "IMAGE_PNG",
            "name": "Lockman - DuBuque",
            "type": shared.AdsAssetType.IMAGE,
            "updated_at": parse_datetime("2022-03-15T11:12:00.931Z"),
...
with UnifiedTo(
    ...
    res = unified_to.ads.create_ads_group(request={
        "ads_group": {
            ...
            "end_at": parse_datetime("2026-05-25T10:39:26.704Z"),
            "id": "0c9310b7-2605-42bc-b656-3d318f4422b3",
            "language_locale": "fr-FR",
            "name": "Stark - Baumbach",
            "start_at": parse_datetime("2025-12-11T17:05:44.743Z"),
            "status": shared.AdsGroupStatus.PROCESSING,
            "targeting": {},
            "updated_at": parse_datetime("2022-01-03T00:12:01.295Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.ads.create_ads_organization(request={
        "ads_organization": {
            ...
            "currency": "USD",
            "id": "78fda14e-099f-40d2-ba57-c7563ca6c5e1",
            "managers": [
                {
            ...
            "updated_at": parse_datetime("2026-02-27T22:51:49.617Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.ads.patch_ads_ad(request={
        "ads_ad": {
            ...
            "description": "Accedo vespillo carpo dolor decet stillicidium comptus tenuis.",
            "final_url": "https://improbable-sanity.com",
            "id": "791b161e-b54a-4df6-a2aa-1eb1b8fbdc1a",
            "name": "Hermiston Group",
            "status": shared.AdsAdStatus.ARCHIVED,
            "updated_at": parse_datetime("2024-06-05T11:45:25.427Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.ads.patch_ads_group(request={
        "ads_group": {
            ...
            "currency": "USD",
            "effective_status": shared.AdsGroupEffectiveStatus.PAUSED,
            "end_at": parse_datetime("2026-05-25T10:39:26.858Z"),
            "id": "62e0b7b4-3a8f-4a3b-9e59-2cfcfc725a00",
            "language_locale": "fr-FR",
            "name": "Stark - Baumbach",
            "start_at": parse_datetime("2025-12-11T17:05:44.886Z"),
            "status": shared.AdsGroupStatus.PROCESSING,
            "targeting": {},
            "updated_at": parse_datetime("2022-01-03T00:12:01.348Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.ads.patch_ads_organization(request={
        "ads_organization": {
            ...
            "created_at": parse_datetime("2020-07-23T21:47:11.440Z"),
            "currency": "USD",
            "id": "c2fdea04-dda1-42ac-9029-0a0896c73fa7",
            "managers": [
                {
                    "id": "e4fd87df-9f8b-4fa0-a77b-b7d18669e350",
                    "name": "Parker, Leannon and Gibson",
            ...
            "status": shared.AdsOrganizationStatus.PROCESSING,
            "timezone": "Europe/Chisinau",
            "updated_at": parse_datetime("2026-02-27T22:51:49.625Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
