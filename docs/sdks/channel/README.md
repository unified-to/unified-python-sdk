...
with UnifiedTo(
    ...
    res = unified_to.channel.create_messaging_channel(request={
        "messaging_channel": {
            ...
            "id": "fdc62276-3b22-4f42-8caa-00896e96822a",
            "is_active": False,
            "is_private": True,
            "members": [],
            "name": "tego",
            "updated_at": parse_datetime("2026-04-23T21:41:16.759Z"),
...
with UnifiedTo(
    ...
    res = unified_to.channel.patch_messaging_channel(request={
        "messaging_channel": {
            ...
            "description": "Dolores tutis.",
            "has_subchannels": True,
            "id": "7489355e-7030-4774-8596-a48645b2515a",
            "is_active": False,
            "is_private": True,
            "members": [],
            "name": "tego",
            "updated_at": parse_datetime("2026-04-23T21:41:16.770Z"),
            "web_url": "https://svelte-rule.name/",
        },
        "connection_id": "<id>",
        "id": "<id>",
