...
with UnifiedTo(
    ...
    res = unified_to.journal.create_accounting_journal(request={
        "accounting_journal": {
            ...
            "posted_at": parse_datetime("2023-10-20T15:13:49.802Z"),
            "reference": "ullam",
            "source": "crustulum",
            "status": shared.AccountingJournalStatus.VOID,
            "tax_amount": 78672.0,
            "total_amount": 74094.0,
            "updated_at": parse_datetime("2022-01-02T06:10:58.511Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.journal.patch_accounting_journal(request={
        "accounting_journal": {
            ...
            "is_inclusive_of_tax": True,
            "posted_at": parse_datetime("2023-10-20T15:13:49.817Z"),
            "reference": "ullam",
            "source": "crustulum",
            "status": shared.AccountingJournalStatus.VOID,
            "tax_amount": 78672.0,
            "total_amount": 74094.0,
            "updated_at": parse_datetime("2022-01-02T06:10:58.518Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
