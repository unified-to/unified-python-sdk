...
with UnifiedTo(
    ...
    res = unified_to.journal.create_accounting_journal(request={
        "accounting_journal": {
            ...
            "id": "a172febd-f7eb-4449-af73-c82d7416dcb2",
            "posted_at": parse_datetime("2023-10-19T14:18:30.414Z"),
            "reference": "ullam",
            "source": "crustulum",
            "tax_amount": 78672.0,
            "updated_at": parse_datetime("2022-01-01T17:29:12.407Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.journal.patch_accounting_journal(request={
        "accounting_journal": {
            ...
            "currency": "FKP",
            "description": "Calco constans adipisci.",
            "id": "5dd5aaea-87f5-4207-8900-592794fc9493",
            "posted_at": parse_datetime("2023-10-19T14:18:30.423Z"),
            "reference": "ullam",
            "source": "crustulum",
            "tax_amount": 78672.0,
            "updated_at": parse_datetime("2022-01-01T17:29:12.412Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
