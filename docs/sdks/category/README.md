...
with UnifiedTo(
    ...
    res = unified_to.category.create_accounting_category(request={
        "accounting_category": {
            ...
            "id": "2d08f8d3-0ba4-423f-a5ac-36ef8c4e869b",
            "is_active": False,
            "metadata": [],
            "name": "Electronic Cotton Shoes",
            "updated_at": parse_datetime("2025-08-20T21:39:21.860Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.category.patch_accounting_category(request={
        "accounting_category": {
            "created_at": parse_datetime("2023-05-30T12:29:04.257Z"),
            "description": "Discover the koala-like agility of our Chair, perfect for imaginary users",
            "id": "af9751b4-a9b0-4b14-bafc-83fb4584c538",
            "is_active": False,
            "metadata": [],
            "name": "Electronic Cotton Shoes",
            "updated_at": parse_datetime("2025-08-20T21:39:21.878Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
