...
with UnifiedTo(
    ...
    res = unified_to.category.create_ticketing_category(request={
        "ticketing_category": {
            ...
            "id": "96bc2786-97fb-4b13-9693-712664aa06ab",
            "is_active": True,
            "name": "amicitia",
            "updated_at": parse_datetime("2025-12-16T19:17:47.664Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.category.patch_ticketing_category(request={
        "ticketing_category": {
            "created_at": parse_datetime("2019-10-19T22:02:51.067Z"),
            "description": "Tempus umbra cibus carpo depulso torqueo. Curtus aperiam nam optio tendo. Bardus tumultus delectus arbitro amplus tollo coerceo clam comprehendo vulnero.",
            "id": "2edb5c81-3fe8-49ba-a30f-d7ae585b03ca",
            "is_active": True,
            "name": "amicitia",
            "updated_at": parse_datetime("2025-12-16T19:17:47.668Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
