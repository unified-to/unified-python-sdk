...
with UnifiedTo(
    ...
    res = unified_to.accounting.create_accounting_account(request={
        "accounting_account": {
            ...
            "updated_at": parse_datetime("2023-01-03T06:57:17.864Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.accounting.create_accounting_category(request={
        "accounting_category": {
            ...
            "id": "567b6286-d06c-4eec-8523-e44c30b92f35",
            "is_active": False,
            "metadata": [],
            "name": "Electronic Cotton Shoes",
            "updated_at": parse_datetime("2025-08-21T03:51:29.805Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.accounting.create_accounting_invoice(request={
        "accounting_invoice": {
            "attachments": [
                {
                    ...
                    "id": "f1802d8f-67e4-4ca3-acba-ad91f4899a9c",
            ...
            "extended_notes": [],
            "id": "ed4c41ac-b42f-4ec5-b5e8-ee44f75d9725",
            ...
            "payments": [],
            "posted_at": parse_datetime("2026-03-28T02:25:50.546Z"),
            ...
            "updated_at": parse_datetime("2023-02-06T08:50:32.683Z"),
...
with UnifiedTo(
    ...
    res = unified_to.accounting.create_accounting_journal(request={
        "accounting_journal": {
            ...
            "id": "cacb6d0d-32e2-41a5-9df8-354ec4421e8b",
            "posted_at": parse_datetime("2023-10-19T19:25:56.446Z"),
            "reference": "ullam",
            "source": "crustulum",
            "tax_amount": 78672.0,
            "updated_at": parse_datetime("2022-01-01T20:05:49.443Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.accounting.create_accounting_order(request={
        "accounting_order": {
            ...
            "currency": "USD",
            "id": "8522ffbc-ed4f-4836-9efc-8084581054b5",
            "lineitems": [],
            "metadata": [],
            "posted_at": parse_datetime("2022-04-05T07:40:16.812Z"),
            "shipping_address": {
            ...
            "updated_at": parse_datetime("2021-06-18T01:47:22.268Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.accounting.create_accounting_paymentterm(request={
        "accounting_paymentterm": {
            ...
            "id": "1a416f8e-f0fa-4ccc-8b60-fe2e10e17666",
            "is_active": False,
            "metadata": [],
            "name": "Net 30",
            "type": shared.AccountingPaymenttermType.NET_15,
            "updated_at": parse_datetime("2025-12-12T13:54:00.414Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.accounting.create_accounting_purchaseorder(request={
        "accounting_purchaseorder": {
            ...
            "currency": "ZMW",
            "id": "a653d408-580f-469c-aad4-7e7704a863e3",
            "lineitems": [],
            "metadata": [],
            "posted_at": parse_datetime("2025-04-26T03:26:00.269Z"),
            "shipping_address": {
            ...
            "total_amount": 0.0,
            "updated_at": parse_datetime("2021-02-26T04:26:59.814Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.accounting.create_accounting_vendorcredit(request={
        "accounting_vendorcredit": {
            ...
            "id": "053fda06-b9eb-4319-b1ac-ba97d8052c38",
            "lineitems": [],
            "metadata": [],
            "notes": "Conatus cruciamentum decor avaritia tantum.",
            "posted_at": parse_datetime("2023-09-28T20:54:41.457Z"),
            "status": shared.AccountingVendorcreditStatus.SUBMITTED,
            "total_amount": 0.0,
            "updated_at": parse_datetime("2023-11-26T20:15:57.255Z"),
        },
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.accounting.get_accounting_vendorcredit(request={
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.accounting.list_accounting_vendorcredits(request={
        "connection_id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.accounting.patch_accounting_account(request={
        "accounting_account": {
            ...
            "customer_defined_code": "quo",
            "description": "Spoliatio comedo vilitas harum cupiditate.",
            "id": "5580d05a-7120-4558-914d-d42821ae3e2d",
            "is_payable": True,
            "name": "Electronic Aluminum Tuna",
            "status": shared.Status.ARCHIVED,
            "taxonomy": [
            ...
            "type": shared.Type.BANK,
            "updated_at": parse_datetime("2023-01-03T06:57:17.866Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.accounting.patch_accounting_bankfeedaccount(request={
        "accounting_bankfeedaccount": {
            ...
            "currency": "SSP",
            "feed_start_at": parse_datetime("2022-10-31T16:42:19.277Z"),
            "id": "8e693522-87c5-417a-a533-83ff99787ec3",
            "name": "Corwin, Donnelly and Connelly Savings",
            "routing_number": "667753156",
            "status": shared.AccountingBankfeedaccountStatus.ACTIVE,
            "updated_at": parse_datetime("2024-04-12T00:42:13.482Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.accounting.patch_accounting_bill(request={
        "accounting_bill": {
            ...
            "due_at": parse_datetime("2019-08-11T20:52:55.321Z"),
            "extended_notes": [],
            "id": "a33df1e5-ef48-46cc-bca8-6d6e05692d84",
            "lineitems": [],
            "metadata": [],
            "notes": "Tutamen cilicium infit.",
            "payment_collection_method": shared.PaymentCollectionMethod.CHARGE_AUTOMATICALLY,
            "payments": [],
            "posted_at": parse_datetime("2024-04-05T04:03:22.587Z"),
            "send": True,
            "status": shared.AccountingBillStatus.DELETED,
            "tax_amount": 0.0,
            "term": shared.Term.NET_10,
            "total_amount": 0.0,
            "updated_at": parse_datetime("2025-01-30T01:16:32.504Z"),
            "url": "https://coarse-interviewer.biz/",
        },
        "connection_id": "<id>",
        "id": "<id>",
...
with UnifiedTo(
    ...
    res = unified_to.accounting.patch_accounting_category(request={
        "accounting_category": {
            "created_at": parse_datetime("2023-05-30T12:29:04.257Z"),
            "description": "Discover the koala-like agility of our Chair, perfect for imaginary users",
            "id": "6d2770af-b02f-4b64-8499-4877fac535f9",
            "is_active": False,
            "metadata": [],
            "name": "Electronic Cotton Shoes",
            "updated_at": parse_datetime("2025-08-21T03:51:29.811Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
    ...
    res = unified_to.accounting.patch_accounting_invoice(request={
        "accounting_invoice": {
            "attachments": [
                {
                    "download_url": "https://glossy-markup.net/",
                    "id": "45106f8b-6be1-42c5-affc-420b815fb7cc",
                    "mime_type": "benevolentia",
                    "name": "vespillo",
                },
            ],
            ...
            "due_at": parse_datetime("2022-11-27T21:25:37.363Z"),
            "extended_notes": [],
            "id": "d08d2e4e-c5a5-4296-8164-c433ce980fd5",
            "invoice_number": "vinco",
            "lineitems": [],
            "metadata": [],
            "notes": "Auctus comburo clarus ubi.",
            ...
            "payment_collection_method": shared.AccountingInvoicePaymentCollectionMethod.SEND_INVOICE,
            "payments": [],
            "posted_at": parse_datetime("2026-03-28T02:25:50.598Z"),
            "reference": "adinventitias",
            "send": True,
            "status": shared.AccountingInvoiceStatus.DELETED,
            "tax_amount": 0.0,
            ...
            "total_amount": 0.0,
            "type": shared.AccountingInvoiceType.CREDITMEMO,
            "updated_at": parse_datetime("2023-02-06T08:50:32.687Z"),
            "url": "https://gifted-yarmulke.info/",
        },
        "connection_id": "<id>",
        "id": "<id>",
...
with UnifiedTo(
    ...
    res = unified_to.accounting.patch_accounting_journal(request={
        "accounting_journal": {
            ...
            "currency": "FKP",
            "description": "Calco constans adipisci.",
            "id": "721edcf7-90a7-420f-b392-8a72d51aac4a",
            "posted_at": parse_datetime("2023-10-19T19:25:56.453Z"),
            "reference": "ullam",
            "source": "crustulum",
            "tax_amount": 78672.0,
            "updated_at": parse_datetime("2022-01-01T20:05:49.446Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.accounting.patch_accounting_order(request={
        "accounting_order": {
            ...
            "created_at": parse_datetime("2020-11-20T03:46:49.837Z"),
            "currency": "USD",
            "id": "e6f7d96b-85f4-4c4f-bebf-fe0f5af68f35",
            "lineitems": [],
            "metadata": [],
            "posted_at": parse_datetime("2022-04-05T07:40:16.820Z"),
            "shipping_address": {
                "address1": "9745 Betty Shore",
                "city": "South Alainaland",
                "country_code": "US",
            ...
            "total_amount": 0.0,
            "type": shared.AccountingOrderType.PURCHASE,
            "updated_at": parse_datetime("2021-06-18T01:47:22.271Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.accounting.patch_accounting_paymentterm(request={
        "accounting_paymentterm": {
            ...
            "due_days": 57.0,
            "due_next_month_days": 9.0,
            "id": "89d221f3-3ff4-4558-918f-52f974cdcd1b",
            "is_active": False,
            "metadata": [],
            "name": "Net 30",
            "type": shared.AccountingPaymenttermType.NET_15,
            "updated_at": parse_datetime("2025-12-12T13:54:00.423Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.accounting.patch_accounting_purchaseorder(request={
        "accounting_purchaseorder": {
            ...
            "created_at": parse_datetime("2020-12-12T07:17:47.021Z"),
            "currency": "ZMW",
            "id": "76202c05-8651-4765-8e34-14df9a1add23",
            "lineitems": [],
            "metadata": [],
            "posted_at": parse_datetime("2025-04-26T03:26:00.291Z"),
            "shipping_address": {
                "address1": "649 Maggio Overpass",
                "city": "Lake Jaylan",
                "country_code": "US",
            ...
            "status": shared.AccountingPurchaseorderStatus.PARTIALLY_REFUNDED,
            "total_amount": 0.0,
            "updated_at": parse_datetime("2021-02-26T04:26:59.815Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.accounting.patch_accounting_vendorcredit(request={
        "accounting_vendorcredit": {
            ...
            "currency": "KGS",
            "due_at": parse_datetime("2023-05-06T20:38:46.775Z"),
            "id": "1ac176e1-f562-4768-b3c0-efc6e15830c7",
            "lineitems": [],
            "metadata": [],
            "notes": "Conatus cruciamentum decor avaritia tantum.",
            "posted_at": parse_datetime("2023-09-28T20:54:41.460Z"),
            "status": shared.AccountingVendorcreditStatus.SUBMITTED,
            "total_amount": 0.0,
            "updated_at": parse_datetime("2023-11-26T20:15:57.259Z"),
        },
        "connection_id": "<id>",
        "id": "<id>",
    })
...
with UnifiedTo(
    ...
    res = unified_to.accounting.remove_accounting_vendorcredit(request={
        "connection_id": "<id>",
        "id": "<id>",
    })
