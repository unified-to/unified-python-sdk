...
<!-- UsageSnippet language="python" operationID="getUnifiedIntegrationSaml" method="get" path="/unified/integration/saml/{workspace_id}/{integration_type}" -->
```python
from unified_python_sdk import UnifiedTo
from unified_python_sdk.models import shared
...
with UnifiedTo(
    ...
    res = unified_to.login.get_unified_integration_saml(request={
        "integration_type": "<value>",
        "workspace_id": "<id>",
    })
