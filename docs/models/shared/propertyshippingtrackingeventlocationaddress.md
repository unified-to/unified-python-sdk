...
| `delivery_instructions` | *Optional[str]*         | :heavy_minus_sign:      | N/A                     |
| `email`                 | *Optional[str]*         | :heavy_minus_sign:      | N/A                     |
| `is_residential`        | *Optional[bool]*        | :heavy_minus_sign:      | N/A                     |
| `is_validated`          | *Optional[bool]*        | :heavy_minus_sign:      | N/A                     |
