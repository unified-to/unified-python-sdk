...
class Payment:
    ...
    def remove_payment_link(self, request: operations.RemovePaymentLinkRequest) -> operations.RemovePaymentLinkResponse:
        ...
        res = operations.RemovePaymentLinkResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res, headers=None)
    ...
    def remove_payment_payment(self, request: operations.RemovePaymentPaymentRequest) -> operations.RemovePaymentPaymentResponse:
        ...
        res = operations.RemovePaymentPaymentResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res, headers=None)
