...
class PropertyUserMetaResourceType(str, Enum):
    USER = 'User'
    GROUP = 'Group'
...
class PropertyUserMeta:
    ...
    resource_type: Optional[PropertyUserMetaResourceType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resourceType'), 'exclude': lambda f: f is None }})
