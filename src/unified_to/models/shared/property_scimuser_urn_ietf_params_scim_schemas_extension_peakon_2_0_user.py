...
class PropertyScimUserUrnIetfParamsScimSchemasExtensionPeakon20User:
    ...
    gender: Optional[PropertyScimUserUrnIetfParamsScimSchemasExtensionPeakon20UserGender] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Gender'), 'exclude': lambda f: f is None }})
