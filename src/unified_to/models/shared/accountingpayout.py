...
class AccountingPayoutStatus(str, Enum):
    SUCCEEDED = 'SUCCEEDED'
    PENDING = 'PENDING'
    FAILED = 'FAILED'
    CANCELED = 'CANCELED'
...
class AccountingPayout:
    ...
    status: Optional[AccountingPayoutStatus] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
