...
class AtsApplication:
    ...
    offers: Optional[List[AtsOffer]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('offers'), 'exclude': lambda f: f is None }})
