...
from .property_accountingtaxrate_raw import PropertyAccountingTaxrateRaw
...
class AccountingTaxrate:
    ...
    raw: Optional[PropertyAccountingTaxrateRaw] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('raw'), 'exclude': lambda f: f is None }})
