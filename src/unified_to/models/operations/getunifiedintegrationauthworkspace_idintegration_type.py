...
class GetUnifiedIntegrationAuthWorkspaceIDIntegrationTypeScopes(str, Enum):
...
class GetUnifiedIntegrationAuthWorkspaceIDIntegrationTypeRequest:
    ...
    scopes: Optional[list[GetUnifiedIntegrationAuthWorkspaceIDIntegrationTypeScopes]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'scopes', 'style': 'form', 'explode': True }})
