...
from ...models.shared import accountingpayout as shared_accountingpayout
...
class ListAccountingPayoutsResponse:
    ...
    accounting_payouts: Optional[List[shared_accountingpayout.AccountingPayout]] = dataclasses.field(default=None)
    r"""Successful"""
