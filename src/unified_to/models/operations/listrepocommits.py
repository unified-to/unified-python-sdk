...
from ...models.shared import repocommit as shared_repocommit
...
class ListRepoCommitsRequest:
    ...
    branch_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'branch_id', 'style': 'form', 'explode': True }})
    ...
    repo_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'repo_id', 'style': 'form', 'explode': True }})
...
class ListRepoCommitsResponse:
    ...
    repo_commits: Optional[List[shared_repocommit.RepoCommit]] = dataclasses.field(default=None)
    r"""Successful"""
