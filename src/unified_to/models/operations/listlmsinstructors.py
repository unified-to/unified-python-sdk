...
from ...models.shared import lmsinstructor as shared_lmsinstructor
...
class ListLmsInstructorsRequest:
    ...
    class_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'class_id', 'style': 'form', 'explode': True }})
    ...
    course_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'course_id', 'style': 'form', 'explode': True }})
...
class ListLmsInstructorsResponse:
    ...
    lms_instructors: Optional[List[shared_lmsinstructor.LmsInstructor]] = dataclasses.field(default=None)
    r"""Successful"""
