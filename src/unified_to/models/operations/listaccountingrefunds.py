...
from ...models.shared import accountingrefund as shared_accountingrefund
...
class ListAccountingRefundsResponse:
    ...
    accounting_refunds: Optional[List[shared_accountingrefund.AccountingRefund]] = dataclasses.field(default=None)
    r"""Successful"""
