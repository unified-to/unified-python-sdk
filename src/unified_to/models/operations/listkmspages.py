...
class ListKmsPagesRequest:
    ...
    space_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'space_id', 'style': 'form', 'explode': True }})
...
class ListKmsPagesResponse:
    ...
    kms_pages: Optional[List[shared_kmspage.KmsPage]] = dataclasses.field(default=None)
    r"""Successful"""
