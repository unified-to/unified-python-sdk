...
class GetUnifiedConnectionRequest:
    categories: Optional[list[GetUnifiedConnectionCategories]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'categories', 'style': 'form', 'explode': True }})
