...
class Page:
    ...
    def remove_kms_page(self, request: operations.RemoveKmsPageRequest) -> operations.RemoveKmsPageResponse:
        ...
        res = operations.RemoveKmsPageResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res, headers=None)
