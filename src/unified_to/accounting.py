...
class Accounting:
    ...
    def create_accounting_order(self, request: operations.CreateAccountingOrderRequest) -> operations.CreateAccountingOrderResponse:
        r"""Create an order"""
        hook_ctx = HookContext(operation_id='createAccountingOrder', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        
        url = utils.generate_url(base_url, '/accounting/{connection_id}/order', request)
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.CreateAccountingOrderRequest, "accounting_order", False, True, 'json')
        if req_content_type is not None and req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = { **utils.get_query_params(request), **query_params }
        headers['Accept'] = 'application/json'
        ...
        res = operations.CreateAccountingOrderResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
        
        if http_res.status_code == 200:
            # pylint: disable=no-else-return
            if utils.match_content_type(http_res.headers.get('Content-Type') or '', 'application/json'):                
                out = utils.unmarshal_json(http_res.text, Optional[shared.AccountingOrder])
    ...
    def get_accounting_order(self, request: operations.GetAccountingOrderRequest) -> operations.GetAccountingOrderResponse:
        r"""Retrieve an order"""
        hook_ctx = HookContext(operation_id='getAccountingOrder', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        
        url = utils.generate_url(base_url, '/accounting/{connection_id}/order/{id}', request)
        ...
        res = operations.GetAccountingOrderResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def list_accounting_orders(self, request: operations.ListAccountingOrdersRequest) -> operations.ListAccountingOrdersResponse:
        r"""List all orders"""
        hook_ctx = HookContext(operation_id='listAccountingOrders', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.ListAccountingOrdersResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
        
        if http_res.status_code == 200:
            # pylint: disable=no-else-return
            if utils.match_content_type(http_res.headers.get('Content-Type') or '', 'application/json'):                
                out = utils.unmarshal_json(http_res.text, Optional[List[shared.AccountingOrder]])
    ...
    def patch_accounting_order(self, request: operations.PatchAccountingOrderRequest) -> operations.PatchAccountingOrderResponse:
        r"""Update an order"""
        hook_ctx = HookContext(operation_id='patchAccountingOrder', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.PatchAccountingOrderRequest, "accounting_order", False, True, 'json')
        if req_content_type is not None and req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = { **utils.get_query_params(request), **query_params }
        headers['Accept'] = 'application/json'
        ...
        res = operations.PatchAccountingOrderResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def remove_accounting_account(self, request: operations.RemoveAccountingAccountRequest) -> operations.RemoveAccountingAccountResponse:
        ...
        res = operations.RemoveAccountingAccountResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res, headers=None)
    ...
    def remove_accounting_contact(self, request: operations.RemoveAccountingContactRequest) -> operations.RemoveAccountingContactResponse:
        ...
        res = operations.RemoveAccountingContactResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res, headers=None)
    ...
    def remove_accounting_invoice(self, request: operations.RemoveAccountingInvoiceRequest) -> operations.RemoveAccountingInvoiceResponse:
        ...
        res = operations.RemoveAccountingInvoiceResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res, headers=None)
    ...
    def remove_accounting_journal(self, request: operations.RemoveAccountingJournalRequest) -> operations.RemoveAccountingJournalResponse:
        ...
        res = operations.RemoveAccountingJournalResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res, headers=None)
    ...
    def remove_accounting_order(self, request: operations.RemoveAccountingOrderRequest) -> operations.RemoveAccountingOrderResponse:
        r"""Remove an order"""
        hook_ctx = HookContext(operation_id='removeAccountingOrder', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.RemoveAccountingOrderResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res, headers=None)
    ...
    def remove_accounting_taxrate(self, request: operations.RemoveAccountingTaxrateRequest) -> operations.RemoveAccountingTaxrateResponse:
        ...
        res = operations.RemoveAccountingTaxrateResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res, headers=None)
    ...
    def remove_accounting_transaction(self, request: operations.RemoveAccountingTransactionRequest) -> operations.RemoveAccountingTransactionResponse:
        ...
        res = operations.RemoveAccountingTransactionResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res, headers=None)
    ...
    def update_accounting_order(self, request: operations.UpdateAccountingOrderRequest) -> operations.UpdateAccountingOrderResponse:
        r"""Update an order"""
        hook_ctx = HookContext(operation_id='updateAccountingOrder', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.UpdateAccountingOrderRequest, "accounting_order", False, True, 'json')
        if req_content_type is not None and req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = { **utils.get_query_params(request), **query_params }
        headers['Accept'] = 'application/json'
        ...
        res = operations.UpdateAccountingOrderResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
