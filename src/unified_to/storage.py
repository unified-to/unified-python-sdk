...
class Storage:
    ...
    def remove_storage_file(self, request: operations.RemoveStorageFileRequest) -> operations.RemoveStorageFileResponse:
        ...
        res = operations.RemoveStorageFileResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res, headers=None)
