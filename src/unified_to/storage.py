...
class Storage:
    ...
    def create_storage_file(self, request: operations.CreateStorageFileRequest) -> operations.CreateStorageFileResponse:
        ...
        res = operations.CreateStorageFileResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_storage_file(self, request: operations.GetStorageFileRequest) -> operations.GetStorageFileResponse:
        ...
        res = operations.GetStorageFileResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def list_storage_files(self, request: operations.ListStorageFilesRequest) -> operations.ListStorageFilesResponse:
        ...
        res = operations.ListStorageFilesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def patch_storage_file(self, request: operations.PatchStorageFileRequest) -> operations.PatchStorageFileResponse:
        ...
        res = operations.PatchStorageFileResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def update_storage_file(self, request: operations.UpdateStorageFileRequest) -> operations.UpdateStorageFileResponse:
        ...
        res = operations.UpdateStorageFileResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
