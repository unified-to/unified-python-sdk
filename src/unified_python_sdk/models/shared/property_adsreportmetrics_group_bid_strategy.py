...
class PropertyAdsReportMetricsGroupBidStrategyPerformanceGoalType(
...
class PropertyAdsReportMetricsGroupBidStrategyType(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    FIXED_BID = "FIXED_BID"
...
class PropertyAdsReportMetricsGroupBidStrategyYoutubeAndPartnersType(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    UNSPECIFIED = "UNSPECIFIED"
...
class PropertyAdsReportMetricsGroupBidStrategyTypedDict(TypedDict):
...
class PropertyAdsReportMetricsGroupBidStrategy(BaseModel):
    r"""YOUTUBE_AND_PARTNERS"""
    ...
    def serialize_performance_goal_type(self, value):
        if isinstance(value, str):
            try:
                return (
                    shared.PropertyAdsReportMetricsGroupBidStrategyPerformanceGoalType(
                        value
                    )
                )
            except ValueError:
    ...
    def serialize_type(self, value):
        if isinstance(value, str):
            try:
                return shared.PropertyAdsReportMetricsGroupBidStrategyType(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_youtube_and_partners_type(self, value):
        if isinstance(value, str):
            try:
                return shared.PropertyAdsReportMetricsGroupBidStrategyYoutubeAndPartnersType(
                    value
                )
            except ValueError:
                return value
