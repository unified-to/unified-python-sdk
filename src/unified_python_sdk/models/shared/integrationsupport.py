...
class ListBankfeedaccountID(str, Enum, metaclass=utils.OpenEnumMeta):
    SUPPORTED_REQUIRED = "supported-required"
    SUPPORTED = "supported"
    NOT_SUPPORTED = "not-supported"
...
class ListFulltext(str, Enum, metaclass=utils.OpenEnumMeta):
    SUPPORTED_REQUIRED = "supported-required"
    SUPPORTED = "supported"
    NOT_SUPPORTED = "not-supported"
...
class ListPostID(str, Enum, metaclass=utils.OpenEnumMeta):
    SUPPORTED_REQUIRED = "supported-required"
    SUPPORTED = "supported"
    NOT_SUPPORTED = "not-supported"
...
class ListTableID(str, Enum, metaclass=utils.OpenEnumMeta):
    SUPPORTED_REQUIRED = "supported-required"
    SUPPORTED = "supported"
    NOT_SUPPORTED = "not-supported"
...
class NativeWebhookDatabaseID(str, Enum, metaclass=utils.OpenEnumMeta):
    SUPPORTED_REQUIRED = "supported-required"
    SUPPORTED = "supported"
    NOT_SUPPORTED = "not-supported"
...
class NativeWebhookListID(str, Enum, metaclass=utils.OpenEnumMeta):
    SUPPORTED_REQUIRED = "supported-required"
    SUPPORTED = "supported"
    NOT_SUPPORTED = "not-supported"


class NativeWebhookMemberID(str, Enum, metaclass=utils.OpenEnumMeta):
    SUPPORTED_REQUIRED = "supported-required"
    SUPPORTED = "supported"
    NOT_SUPPORTED = "not-supported"
...
class NativeWebhookTableID(str, Enum, metaclass=utils.OpenEnumMeta):
    SUPPORTED_REQUIRED = "supported-required"
    SUPPORTED = "supported"
    NOT_SUPPORTED = "not-supported"
...
class VirtualWebhookBankfeedaccountID(str, Enum, metaclass=utils.OpenEnumMeta):
    SUPPORTED_REQUIRED = "supported-required"
    SUPPORTED = "supported"
    NOT_SUPPORTED = "not-supported"
...
class VirtualWebhookPostID(str, Enum, metaclass=utils.OpenEnumMeta):
    SUPPORTED_REQUIRED = "supported-required"
    SUPPORTED = "supported"
    NOT_SUPPORTED = "not-supported"
...
class VirtualWebhookTableID(str, Enum, metaclass=utils.OpenEnumMeta):
    SUPPORTED_REQUIRED = "supported-required"
    SUPPORTED = "supported"
    NOT_SUPPORTED = "not-supported"
...
class IntegrationSupportTypedDict(TypedDict):
    ...
    list_post_id: NotRequired[ListPostID]
    ...
    list_table_id: NotRequired[ListTableID]
    ...
    native_webhook_database_id: NotRequired[NativeWebhookDatabaseID]
    ...
    native_webhook_list_id: NotRequired[NativeWebhookListID]
    ...
    virtual_webhook_post_id: NotRequired[VirtualWebhookPostID]
    ...
    virtual_webhook_table_id: NotRequired[VirtualWebhookTableID]
...
class IntegrationSupport(BaseModel):
    ...
    list_bankfeedaccount_id: Optional[ListBankfeedaccountID] = None
    ...
    list_post_id: Optional[ListPostID] = None
    ...
    list_table_id: Optional[ListTableID] = None
    ...
    native_webhook_database_id: Optional[NativeWebhookDatabaseID] = None
    ...
    native_webhook_list_id: Optional[NativeWebhookListID] = None
    ...
    native_webhook_table_id: Optional[NativeWebhookTableID] = None
    ...
    virtual_webhook_post_id: Optional[VirtualWebhookPostID] = None
    ...
    virtual_webhook_table_id: Optional[VirtualWebhookTableID] = None
    ...
    @field_serializer("list_assigned_user_id")
    def serialize_list_assigned_user_id(self, value):
        if isinstance(value, str):
            try:
                return shared.ListAssignedUserID(value)
            except ValueError:
                return value
        return value

    @field_serializer("list_bankfeedaccount_id")
    def serialize_list_bankfeedaccount_id(self, value):
        if isinstance(value, str):
            try:
                return shared.ListBankfeedaccountID(value)
            except ValueError:
                return value
        return value
    ...
    @field_serializer("list_database_id")
    def serialize_list_database_id(self, value):
        if isinstance(value, str):
            try:
                return shared.ListDatabaseID(value)
            except ValueError:
                return value
        return value
    ...
    @field_serializer("list_fulltext")
    def serialize_list_fulltext(self, value):
        if isinstance(value, str):
            try:
    ...
    @field_serializer("list_post_id")
    def serialize_list_post_id(self, value):
        if isinstance(value, str):
            try:
                return shared.ListPostID(value)
            except ValueError:
                return value
        return value
    ...
    @field_serializer("list_table_id")
    def serialize_list_table_id(self, value):
        if isinstance(value, str):
            try:
                return shared.ListTableID(value)
            except ValueError:
                return value
        return value
    ...
    @field_serializer("native_webhook_database_id")
    def serialize_native_webhook_database_id(self, value):
        if isinstance(value, str):
            try:
                return shared.NativeWebhookDatabaseID(value)
            except ValueError:
                return value
        return value
    ...
    @field_serializer("native_webhook_list_id")
    def serialize_native_webhook_list_id(self, value):
        if isinstance(value, str):
            try:
                return shared.NativeWebhookListID(value)
            except ValueError:
                return value
        return value

    @field_serializer("native_webhook_member_id")
    def serialize_native_webhook_member_id(self, value):
        if isinstance(value, str):
            try:
                return shared.NativeWebhookMemberID(value)
            except ValueError:
                return value
        return value
    ...
    @field_serializer("native_webhook_table_id")
    def serialize_native_webhook_table_id(self, value):
        if isinstance(value, str):
            try:
                return shared.NativeWebhookTableID(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_virtual_webhook_assigned_user_id(self, value):
        if isinstance(value, str):
            try:
                return shared.VirtualWebhookAssignedUserID(value)
            except ValueError:
                return value
        return value

    @field_serializer("virtual_webhook_bankfeedaccount_id")
    def serialize_virtual_webhook_bankfeedaccount_id(self, value):
        if isinstance(value, str):
            try:
                return shared.VirtualWebhookBankfeedaccountID(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_virtual_webhook_database_id(self, value):
        if isinstance(value, str):
            try:
                return shared.VirtualWebhookDatabaseID(value)
            except ValueError:
                return value
        return value
    ...
    @field_serializer("virtual_webhook_post_id")
    def serialize_virtual_webhook_post_id(self, value):
        if isinstance(value, str):
            try:
                return shared.VirtualWebhookPostID(value)
            except ValueError:
                return value
        return value
    ...
    @field_serializer("virtual_webhook_table_id")
    def serialize_virtual_webhook_table_id(self, value):
        if isinstance(value, str):
            try:
                return shared.VirtualWebhookTableID(value)
            except ValueError:
                return value
        return value
