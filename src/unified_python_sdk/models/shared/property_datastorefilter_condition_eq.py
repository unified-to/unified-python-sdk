...
class PropertyDatastoreFilterConditionEqTypedDict(TypedDict):
...
class PropertyDatastoreFilterConditionEq(BaseModel):
...
try:
    PropertyDatastoreFilterConditionEq.model_rebuild()
except NameError:
    pass
