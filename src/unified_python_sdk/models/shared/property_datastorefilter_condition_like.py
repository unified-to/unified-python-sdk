...
class PropertyDatastoreFilterConditionLikeTypedDict(TypedDict):
...
class PropertyDatastoreFilterConditionLike(BaseModel):
...
try:
    PropertyDatastoreFilterConditionLike.model_rebuild()
except NameError:
    pass
