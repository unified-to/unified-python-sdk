...
class PropertyAdsReportMetricsCampaignTargetingContentTypedDict(TypedDict):
    ...
    video: NotRequired[PropertyAdsReportMetricsCampaignTargetingContentVideoTypedDict]


class PropertyAdsReportMetricsCampaignTargetingContent(BaseModel):
    ...
    video: Optional[PropertyAdsReportMetricsCampaignTargetingContentVideo] = None
