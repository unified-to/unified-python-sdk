...
class PropertyDatastoreFilterConditionLteTypedDict(TypedDict):
...
class PropertyDatastoreFilterConditionLte(BaseModel):
...
try:
    PropertyDatastoreFilterConditionLte.model_rebuild()
except NameError:
    pass
