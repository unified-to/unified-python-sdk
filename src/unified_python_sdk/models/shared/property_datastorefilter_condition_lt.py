...
class PropertyDatastoreFilterConditionLtTypedDict(TypedDict):
...
class PropertyDatastoreFilterConditionLt(BaseModel):
...
try:
    PropertyDatastoreFilterConditionLt.model_rebuild()
except NameError:
    pass
