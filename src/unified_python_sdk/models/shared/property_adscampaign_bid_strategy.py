...
class PropertyAdsCampaignBidStrategyType(str, Enum, metaclass=utils.OpenEnumMeta):
    FIXED_BID = "FIXED_BID"
...
class PropertyAdsCampaignBidStrategyTypedDict(TypedDict):
...
class PropertyAdsCampaignBidStrategy(BaseModel):
    r"""YOUTUBE_AND_PARTNERS"""
    ...
    def serialize_type(self, value):
        if isinstance(value, str):
            try:
                return shared.PropertyAdsCampaignBidStrategyType(value)
            except ValueError:
                return value
        return value
