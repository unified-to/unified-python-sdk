...
class PropertyAdsReportMetricsInsertionorderBidStrategyPerformanceGoalType(
...
class PropertyAdsReportMetricsInsertionorderBidStrategyType(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    FIXED_BID = "FIXED_BID"
...
class PropertyAdsReportMetricsInsertionorderBidStrategyYoutubeAndPartnersType(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    UNSPECIFIED = "UNSPECIFIED"
...
class PropertyAdsReportMetricsInsertionorderBidStrategyTypedDict(TypedDict):
    ...
    performance_goal_type: NotRequired[
...
class PropertyAdsReportMetricsInsertionorderBidStrategy(BaseModel):
    r"""YOUTUBE_AND_PARTNERS"""
    ...
    performance_goal_type: Optional[
        PropertyAdsReportMetricsInsertionorderBidStrategyPerformanceGoalType
    ] = None
    ...
    def serialize_performance_goal_type(self, value):
        if isinstance(value, str):
            try:
                return shared.PropertyAdsReportMetricsInsertionorderBidStrategyPerformanceGoalType(
                    value
                )
            except ValueError:
                return value
    ...
    def serialize_type(self, value):
        if isinstance(value, str):
            try:
                return shared.PropertyAdsReportMetricsInsertionorderBidStrategyType(
                    value
                )
            except ValueError:
                return value
    ...
    def serialize_youtube_and_partners_type(self, value):
        if isinstance(value, str):
            try:
                return shared.PropertyAdsReportMetricsInsertionorderBidStrategyYoutubeAndPartnersType(
                    value
                )
            except ValueError:
                return value
