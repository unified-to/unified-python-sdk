...
class PropertyDatastoreFilterConditionNeqTypedDict(TypedDict):
...
class PropertyDatastoreFilterConditionNeq(BaseModel):
...
try:
    PropertyDatastoreFilterConditionNeq.model_rebuild()
except NameError:
    pass
