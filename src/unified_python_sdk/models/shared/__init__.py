...
if TYPE_CHECKING:
    ...
    from .accountingmetadata import (
        AccountingMetadata,
        AccountingMetadata1,
        AccountingMetadata1TypedDict,
        AccountingMetadata5,
        AccountingMetadata5TypedDict,
        AccountingMetadataTypedDict,
        ExtraData,
        ExtraDataTypedDict,
        Five,
        FiveTypedDict,
    ...
    from .analyticsproperty import AnalyticsProperty, AnalyticsPropertyTypedDict
    ...
    from .cdpactivation import (
        CdpActivation,
        CdpActivationStatus,
        CdpActivationTypedDict,
    )
    from .cdpconsent import CdpConsent, CdpConsentStatus, CdpConsentTypedDict
    from .cdpdestination import CdpDestination, CdpDestinationTypedDict, Direction
    from .cdpevent import CdpEvent, CdpEventType, CdpEventTypedDict
    from .cdpidentifier import CdpIdentifier, CdpIdentifierType, CdpIdentifierTypedDict
    from .cdpmetadata import (
        CdpMetadata,
        CdpMetadata1,
        CdpMetadata1TypedDict,
        CdpMetadata5,
        CdpMetadata5TypedDict,
        CdpMetadataExtraData,
        CdpMetadataExtraDataTypedDict,
        CdpMetadataFormat,
        CdpMetadataSchemas1,
        CdpMetadataSchemas1TypedDict,
        CdpMetadataSchemas5,
        CdpMetadataSchemas5TypedDict,
        CdpMetadataTypedDict,
        CdpMetadataValue,
        CdpMetadataValueTypedDict,
    )
    from .cdpprofile import CdpProfile, CdpProfileGender, CdpProfileTypedDict
    from .cdpprofilesegment import CdpProfileSegment, CdpProfileSegmentTypedDict
    from .cdpsegment import CdpSegment, CdpSegmentType, CdpSegmentTypedDict, ComputeMode
    from .cdpsource import CdpSource, CdpSourceDirection, CdpSourceTypedDict
    ...
    from .enrichperson import EnrichPerson, EnrichPersonGender, EnrichPersonTypedDict
    ...
    from .signingdocument import (
        SigningDocument,
        SigningDocumentStatus,
        SigningDocumentTypedDict,
    )
    from .signingsignatory import (
        SigningSignatory,
    ...
    from .ucmetadata import (
        UcMetadata,
        UcMetadata1,
        UcMetadata1TypedDict,
        UcMetadata5,
        UcMetadata5TypedDict,
        UcMetadataExtraData,
        UcMetadataExtraDataTypedDict,
        UcMetadataFormat,
        UcMetadataSchemas1,
        UcMetadataSchemas1TypedDict,
        UcMetadataSchemas5,
        UcMetadataSchemas5TypedDict,
        UcMetadataTypedDict,
        UcMetadataValue,
...
__all__ = [
    ...
    "AnalyticsSession",
    "AnalyticsSessionTypedDict",
    "AnalyticsVisitor",
    "AnalyticsVisitorTypedDict",
    "AssessmentAddress",
    ...
    "CdpConsentTypedDict",
    "CdpDestination",
    "CdpDestinationTypedDict",
    "CdpEvent",
    "CdpEventType",
    "CdpEventTypedDict",
    "CdpIdentifier",
    "CdpIdentifierType",
    "CdpIdentifierTypedDict",
    "CdpMetadata",
    "CdpMetadata1",
    "CdpMetadata1TypedDict",
    "CdpMetadata5",
...
_dynamic_imports: dict[str, str] = {
    ...
    "AccountingMetadata1": ".accountingmetadata",
    "AccountingMetadata1TypedDict": ".accountingmetadata",
    "AccountingMetadata5": ".accountingmetadata",
    "AccountingMetadata5TypedDict": ".accountingmetadata",
    "AccountingMetadataTypedDict": ".accountingmetadata",
    "ExtraData": ".accountingmetadata",
    "ExtraDataTypedDict": ".accountingmetadata",
    "Five": ".accountingmetadata",
    "FiveTypedDict": ".accountingmetadata",
    "Format": ".accountingmetadata",
    "One": ".accountingmetadata",
    "OneTypedDict": ".accountingmetadata",
    "Value": ".accountingmetadata",
    "ValueTypedDict": ".accountingmetadata",
    ...
    "BudgetUnit": ".adscampaign",
    "EffectiveStatus": ".adscampaign",
    "Goal": ".adscampaign",
    ...
    "AdsGroupBudgetUnit": ".adsgroup",
    "AdsGroupEffectiveStatus": ".adsgroup",
    ...
    "AnalyticsEventTypedDict": ".analyticsevent",
    "EventType": ".analyticsevent",
    "AnalyticsProperty": ".analyticsproperty",
    "AnalyticsPropertyTypedDict": ".analyticsproperty",
    ...
    "AnalyticsVisitorTypedDict": ".analyticsvisitor",
    "Gender": ".analyticsvisitor",
    "APICall": ".apicall",
    "APICallType": ".apicall",
    ...
    "AtsMetadataExtraData": ".atsmetadata",
    "AtsMetadataExtraDataTypedDict": ".atsmetadata",
    "AtsMetadataFormat": ".atsmetadata",
    ...
    "CdpActivationStatus": ".cdpactivation",
    "CdpActivationTypedDict": ".cdpactivation",
    "CdpConsent": ".cdpconsent",
    "CdpConsentStatus": ".cdpconsent",
    "CdpConsentTypedDict": ".cdpconsent",
    "CdpDestination": ".cdpdestination",
    "CdpDestinationTypedDict": ".cdpdestination",
    "Direction": ".cdpdestination",
    "CdpEvent": ".cdpevent",
    "CdpEventType": ".cdpevent",
    "CdpEventTypedDict": ".cdpevent",
    "CdpIdentifier": ".cdpidentifier",
    "CdpIdentifierType": ".cdpidentifier",
    "CdpIdentifierTypedDict": ".cdpidentifier",
    "CdpMetadata": ".cdpmetadata",
    "CdpMetadata1": ".cdpmetadata",
    "CdpMetadata1TypedDict": ".cdpmetadata",
    "CdpMetadata5": ".cdpmetadata",
    "CdpMetadata5TypedDict": ".cdpmetadata",
    "CdpMetadataExtraData": ".cdpmetadata",
    "CdpMetadataExtraDataTypedDict": ".cdpmetadata",
    "CdpMetadataFormat": ".cdpmetadata",
    "CdpMetadataSchemas1": ".cdpmetadata",
    "CdpMetadataSchemas1TypedDict": ".cdpmetadata",
    "CdpMetadataSchemas5": ".cdpmetadata",
    "CdpMetadataSchemas5TypedDict": ".cdpmetadata",
    "CdpMetadataTypedDict": ".cdpmetadata",
    "CdpMetadataValue": ".cdpmetadata",
    "CdpMetadataValueTypedDict": ".cdpmetadata",
    "CdpProfile": ".cdpprofile",
    "CdpProfileGender": ".cdpprofile",
    "CdpProfileTypedDict": ".cdpprofile",
    "CdpProfileSegment": ".cdpprofilesegment",
    "CdpProfileSegmentTypedDict": ".cdpprofilesegment",
    "CdpSegment": ".cdpsegment",
    "CdpSegmentType": ".cdpsegment",
    "CdpSegmentTypedDict": ".cdpsegment",
    "ComputeMode": ".cdpsegment",
    "CdpSource": ".cdpsource",
    "CdpSourceDirection": ".cdpsource",
    "CdpSourceTypedDict": ".cdpsource",
    ...
    "EnrichPersonGender": ".enrichperson",
    ...
    "ListApproverUserID": ".integrationsupport",
    ...
    "ListCycleID": ".integrationsupport",
    "ListDatabaseID": ".integrationsupport",
    "ListDealID": ".integrationsupport",
    "ListDestinationID": ".integrationsupport",
    "ListDimension": ".integrationsupport",
    "ListDocumentID": ".integrationsupport",
    "ListEffectiveStatus": ".integrationsupport",
    ...
    "ListSegmentID": ".integrationsupport",
    ...
    "ListVisitorID": ".integrationsupport",
    ...
    "NativeWebhookUpdatedGte": ".integrationsupport",
    "NativeWebhookVisitorID": ".integrationsupport",
    ...
    "VirtualWebhookAccountID": ".integrationsupport",
    "VirtualWebhookAdID": ".integrationsupport",
    "VirtualWebhookApplicationID": ".integrationsupport",
    "VirtualWebhookApproverUserID": ".integrationsupport",
    ...
    "VirtualWebhookCycleID": ".integrationsupport",
    "VirtualWebhookDatabaseID": ".integrationsupport",
    "VirtualWebhookDealID": ".integrationsupport",
    "VirtualWebhookEffectiveStatus": ".integrationsupport",
    ...
    "VirtualWebhookVisitorID": ".integrationsupport",
    "Issue": ".issue",
    "IssueStatus": ".issue",
    ...
    "LmsSubjectTypedDict": ".lmssubject",
    ...
    "PerformanceCycleStatus": ".performancecycle",
    "PerformanceCycleType": ".performancecycle",
    "PerformanceCycleTypedDict": ".performancecycle",
    "PerformanceFeedback": ".performancefeedback",
    "PerformanceFeedbackType": ".performancefeedback",
    "PerformanceFeedbackTypedDict": ".performancefeedback",
    "PerformanceGoal": ".performancegoal",
    "PerformanceGoalSchemasType": ".performancegoal",
    "PerformanceGoalStatus": ".performancegoal",
    "PerformanceGoalTypedDict": ".performancegoal",
    "PerformanceGoalMilestone": ".performancegoalmilestone",
    "PerformanceGoalMilestoneTypedDict": ".performancegoalmilestone",
    "PerformanceReview": ".performancereview",
    "PerformanceReviewStatus": ".performancereview",
    "PerformanceReviewType": ".performancereview",
    "PerformanceReviewTypedDict": ".performancereview",
    "PerformanceReviewQuestion": ".performancereviewquestion",
    "PerformanceReviewQuestionType": ".performancereviewquestion",
    "PerformanceReviewQuestionTypedDict": ".performancereviewquestion",
    ...
    "PropertyAdsReportMetricsCampaignBudgetUnit": ".property_adsreportmetrics_campaign",
    "PropertyAdsReportMetricsCampaignEffectiveStatus": ".property_adsreportmetrics_campaign",
    ...
    "PropertyAnalyticsVisitorMetadataTypedDict": ".property_analyticsvisitor_metadata",
    ...
    "PropertyCdpProfileAddress": ".property_cdpprofile_address",
    "PropertyCdpProfileAddressTypedDict": ".property_cdpprofile_address",
    ...
    "PropertyHrisAttendanceAddress": ".property_hrisattendance_address",
    "PropertyHrisAttendanceAddressTypedDict": ".property_hrisattendance_address",
    ...
    "ShippingShipmentLineitemTypedDict": ".shippingshipmentlineitem",
    ...
    "SigningDocumentStatus": ".signingdocument",
    "SigningDocumentTypedDict": ".signingdocument",
    "SigningSignatory": ".signingsignatory",
    "SigningSignatoryRole": ".signingsignatory",
    "SigningSignatoryStatus": ".signingsignatory",
    ...
    "UcMetadata": ".ucmetadata",
    "UcMetadata1": ".ucmetadata",
    "UcMetadata1TypedDict": ".ucmetadata",
    "UcMetadata5": ".ucmetadata",
    "UcMetadata5TypedDict": ".ucmetadata",
    "UcMetadataExtraData": ".ucmetadata",
    "UcMetadataExtraDataTypedDict": ".ucmetadata",
    "UcMetadataFormat": ".ucmetadata",
    "UcMetadataSchemas1": ".ucmetadata",
    "UcMetadataSchemas1TypedDict": ".ucmetadata",
    "UcMetadataSchemas5": ".ucmetadata",
    "UcMetadataSchemas5TypedDict": ".ucmetadata",
    "UcMetadataTypedDict": ".ucmetadata",
    "UcMetadataValue": ".ucmetadata",
    "UcMetadataValueTypedDict": ".ucmetadata",
