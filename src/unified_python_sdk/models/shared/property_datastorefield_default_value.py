...
class PropertyDatastoreFieldDefaultValueTypedDict(TypedDict):
...
class PropertyDatastoreFieldDefaultValue(BaseModel):
...
try:
    PropertyDatastoreFieldDefaultValue.model_rebuild()
except NameError:
    pass
