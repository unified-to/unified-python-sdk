...
class PropertyAdsInsertionorderBidStrategyPerformanceGoalType(
...
class PropertyAdsInsertionorderBidStrategyType(str, Enum, metaclass=utils.OpenEnumMeta):
    FIXED_BID = "FIXED_BID"
...
class PropertyAdsInsertionorderBidStrategyYoutubeAndPartnersType(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    UNSPECIFIED = "UNSPECIFIED"
...
class PropertyAdsInsertionorderBidStrategyTypedDict(TypedDict):
...
class PropertyAdsInsertionorderBidStrategy(BaseModel):
    r"""YOUTUBE_AND_PARTNERS"""
    ...
    def serialize_performance_goal_type(self, value):
        if isinstance(value, str):
            try:
                return shared.PropertyAdsInsertionorderBidStrategyPerformanceGoalType(
                    value
                )
            except ValueError:
                return value
    ...
    def serialize_type(self, value):
        if isinstance(value, str):
            try:
                return shared.PropertyAdsInsertionorderBidStrategyType(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_youtube_and_partners_type(self, value):
        if isinstance(value, str):
            try:
                return (
                    shared.PropertyAdsInsertionorderBidStrategyYoutubeAndPartnersType(
                        value
                    )
                )
            except ValueError:
