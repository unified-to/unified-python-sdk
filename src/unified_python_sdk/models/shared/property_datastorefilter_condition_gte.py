...
class PropertyDatastoreFilterConditionGteTypedDict(TypedDict):
...
class PropertyDatastoreFilterConditionGte(BaseModel):
...
try:
    PropertyDatastoreFilterConditionGte.model_rebuild()
except NameError:
    pass
