...
class PatchAccountingJournal2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchAccountingJournal2RequestTypedDict(TypedDict):
    accounting_journal: shared_accountingjournal.AccountingJournalTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Journal"""
    fields: NotRequired[List[PatchAccountingJournal2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchAccountingJournal2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchAccountingJournal2QueryParamFields]],
...
class PatchAccountingJournal2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchAccountingJournal2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
