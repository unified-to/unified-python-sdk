...
class ListAccountingProjectsQueryParamFields(str, Enum):
    ID = "id"
...
class ListAccountingProjectsRequestTypedDict(TypedDict):
    connection_id: str
...
class ListAccountingProjectsRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListAccountingProjectsQueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListAccountingProjectsResponseTypedDict(TypedDict):
    content_type: str
    ...
    accounting_projects: NotRequired[
        List[shared_accountingproject.AccountingProjectTypedDict]
    ]
    r"""Successful"""


class ListAccountingProjectsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    accounting_projects: Optional[List[shared_accountingproject.AccountingProject]] = (
        None
    )
    r"""Successful"""
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["AccountingProjects"])
        serialized = handler(self)
        m = {}
