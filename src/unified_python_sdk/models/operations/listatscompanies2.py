...
class ListAtsCompanies2QueryParamFields(str, Enum):
    ID = "id"
...
class ListAtsCompanies2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[ListAtsCompanies2QueryParamFields]]
    r"""Fields to return"""
...
class ListAtsCompanies2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListAtsCompanies2QueryParamFields]],
...
class ListAtsCompanies2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListAtsCompanies2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["AtsCompanies"])
        serialized = handler(self)
        m = {}
