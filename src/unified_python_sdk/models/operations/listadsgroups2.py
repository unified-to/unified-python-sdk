...
class ListAdsGroups2QueryParamFields(str, Enum):
    ID = "id"
...
class ListAdsGroups2RequestTypedDict(TypedDict):
    connection_id: str
    ...
    fields: NotRequired[List[ListAdsGroups2QueryParamFields]]
    r"""Fields to return"""
...
class ListAdsGroups2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListAdsGroups2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListAdsGroups2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListAdsGroups2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
