...
class ListMessagingMessages2QueryParamFields(str, Enum):
    ID = "id"
...
class ListMessagingMessages2RequestTypedDict(TypedDict):
    connection_id: str
    ...
    fields: NotRequired[List[ListMessagingMessages2QueryParamFields]]
    r"""Fields to return"""
...
class ListMessagingMessages2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListMessagingMessages2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListMessagingMessages2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListMessagingMessages2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
