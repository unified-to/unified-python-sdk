...
class PatchAccountingContactQueryParamFields(str, Enum):
    ID = "id"
...
class PatchAccountingContactRequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Contact"""
    fields: NotRequired[List[PatchAccountingContactQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class PatchAccountingContactRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchAccountingContactQueryParamFields]],
