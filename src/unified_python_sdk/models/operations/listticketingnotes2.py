...
class ListTicketingNotes2QueryParamFields(str, Enum):
    ID = "id"
...
class ListTicketingNotes2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    customer_id: NotRequired[str]
    r"""The customer ID to filter by"""
    fields: NotRequired[List[ListTicketingNotes2QueryParamFields]]
    r"""Fields to return"""
...
class ListTicketingNotes2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListTicketingNotes2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListTicketingNotes2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListTicketingNotes2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["TicketingNotes"])
        serialized = handler(self)
        m = {}
