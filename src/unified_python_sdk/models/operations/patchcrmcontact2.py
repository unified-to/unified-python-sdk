...
class PatchCrmContact2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchCrmContact2RequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Contact"""
    fields: NotRequired[List[PatchCrmContact2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchCrmContact2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchCrmContact2QueryParamFields]],
...
class PatchCrmContact2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchCrmContact2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
