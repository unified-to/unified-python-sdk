...
class PatchUcContact2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchUcContact2RequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Contact"""
    fields: NotRequired[List[PatchUcContact2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchUcContact2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchUcContact2QueryParamFields]],
...
class PatchUcContact2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchUcContact2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
