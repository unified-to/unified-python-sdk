...
class CreateMartechMember2QueryParamFields(str, Enum):
    ID = "id"
...
class CreateMartechMember2RequestTypedDict(TypedDict):
    marketing_member: shared_marketingmember.MarketingMemberTypedDict
    r"""A member represents a person"""
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[CreateMartechMember2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class CreateMartechMember2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateMartechMember2QueryParamFields]],
...
class CreateMartechMember2ResponseTypedDict(TypedDict):
    content_type: str
...
class CreateMartechMember2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
