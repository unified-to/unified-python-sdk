...
class UpdateHrisEmployee2QueryParamFields(str, Enum):
    ID = "id"
...
class UpdateHrisEmployee2RequestTypedDict(TypedDict):
    hris_employee: shared_hrisemployee.HrisEmployeeTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Employee"""
    fields: NotRequired[List[UpdateHrisEmployee2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdateHrisEmployee2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateHrisEmployee2QueryParamFields]],
...
class UpdateHrisEmployee2ResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateHrisEmployee2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
