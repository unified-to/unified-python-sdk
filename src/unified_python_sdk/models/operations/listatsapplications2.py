...
class ListAtsApplications2QueryParamFields(str, Enum):
    ID = "id"
...
class ListAtsApplications2RequestTypedDict(TypedDict):
    connection_id: str
    ...
    fields: NotRequired[List[ListAtsApplications2QueryParamFields]]
    r"""Fields to return"""
...
class ListAtsApplications2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListAtsApplications2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListAtsApplications2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListAtsApplications2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
