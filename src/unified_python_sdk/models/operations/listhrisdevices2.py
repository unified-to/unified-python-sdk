...
class ListHrisDevices2QueryParamFields(str, Enum):
    ID = "id"
...
class ListHrisDevices2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[ListHrisDevices2QueryParamFields]]
    r"""Fields to return"""
...
class ListHrisDevices2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListHrisDevices2QueryParamFields]],
...
class ListHrisDevices2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListHrisDevices2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["HrisDevices"])
        serialized = handler(self)
        m = {}
