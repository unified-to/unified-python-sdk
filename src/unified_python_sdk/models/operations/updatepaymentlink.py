...
class UpdatePaymentLinkQueryParamFields(str, Enum):
    ID = "id"
...
class UpdatePaymentLinkRequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Link"""
    fields: NotRequired[List[UpdatePaymentLinkQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class UpdatePaymentLinkRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdatePaymentLinkQueryParamFields]],
