...
class ListAtsCandidates2QueryParamFields(str, Enum):
    ID = "id"
...
class ListAtsCandidates2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    company_id: NotRequired[str]
    r"""The company ID to filter by (reference to AtsCompany)"""
    fields: NotRequired[List[ListAtsCandidates2QueryParamFields]]
    r"""Fields to return"""
...
class ListAtsCandidates2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListAtsCandidates2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListAtsCandidates2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListAtsCandidates2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["AtsCandidates"])
        serialized = handler(self)
        m = {}
