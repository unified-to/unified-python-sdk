...
class CreateRepoOrganizationQueryParamFields(str, Enum):
    ID = "id"
...
class CreateRepoOrganizationRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreateRepoOrganizationQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreateRepoOrganizationRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateRepoOrganizationQueryParamFields]],
