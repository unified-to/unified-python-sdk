...
class CreateUcContactQueryParamFields(str, Enum):
    ID = "id"
...
class CreateUcContactRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreateUcContactQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class CreateUcContactRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateUcContactQueryParamFields]],
...
class CreateUcContactResponseTypedDict(TypedDict):
    content_type: str
...
class CreateUcContactResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
