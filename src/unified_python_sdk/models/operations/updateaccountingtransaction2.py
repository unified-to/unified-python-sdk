...
class UpdateAccountingTransaction2QueryParamFields(str, Enum):
    ID = "id"
...
class UpdateAccountingTransaction2RequestTypedDict(TypedDict):
    accounting_transaction: shared_accountingtransaction.AccountingTransactionTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Transaction"""
    fields: NotRequired[List[UpdateAccountingTransaction2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdateAccountingTransaction2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateAccountingTransaction2QueryParamFields]],
...
class UpdateAccountingTransaction2ResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateAccountingTransaction2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
