...
class CreatePaymentSubscriptionQueryParamFields(str, Enum):
    ID = "id"
...
class CreatePaymentSubscriptionRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreatePaymentSubscriptionQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreatePaymentSubscriptionRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreatePaymentSubscriptionQueryParamFields]],
