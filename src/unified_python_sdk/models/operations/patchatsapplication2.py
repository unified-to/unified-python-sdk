...
class PatchAtsApplication2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchAtsApplication2RequestTypedDict(TypedDict):
    ats_application: shared_atsapplication.AtsApplicationTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Application"""
    fields: NotRequired[List[PatchAtsApplication2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchAtsApplication2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchAtsApplication2QueryParamFields]],
...
class PatchAtsApplication2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchAtsApplication2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
