...
class ListCommerceInventories2QueryParamFields(str, Enum):
    ID = "id"
...
class ListCommerceInventories2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[ListCommerceInventories2QueryParamFields]]
    r"""Fields to return"""
...
class ListCommerceInventories2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListCommerceInventories2QueryParamFields]],
...
class ListCommerceInventories2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListCommerceInventories2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
