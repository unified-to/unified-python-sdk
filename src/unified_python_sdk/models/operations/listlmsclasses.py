...
class ListLmsClassesQueryParamFields(str, Enum):
    ID = "id"
...
class ListLmsClassesRequestTypedDict(TypedDict):
    connection_id: str
...
class ListLmsClassesRequest(BaseModel):
...
class ListLmsClassesResponseTypedDict(TypedDict):
    content_type: str
...
class ListLmsClassesResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
