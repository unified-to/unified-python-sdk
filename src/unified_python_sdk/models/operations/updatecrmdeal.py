...
class UpdateCrmDealQueryParamFields(str, Enum):
    ID = "id"
...
class UpdateCrmDealRequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Deal"""
    fields: NotRequired[List[UpdateCrmDealQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdateCrmDealRequest(BaseModel):
    crm_deal: Annotated[
    ...
    fields: Annotated[
        Optional[List[UpdateCrmDealQueryParamFields]],
...
class UpdateCrmDealResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateCrmDealResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
