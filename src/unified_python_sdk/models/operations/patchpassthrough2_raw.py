...
class PatchPassthrough2RawRequestTypedDict(TypedDict):
    connection_id: str
...
class PatchPassthrough2RawRequest(BaseModel):
...
class PatchPassthrough2RawResponseTypedDict(TypedDict):
    content_type: str
...
class PatchPassthrough2RawResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
