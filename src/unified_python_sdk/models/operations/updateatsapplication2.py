...
class UpdateAtsApplication2QueryParamFields(str, Enum):
    ID = "id"
...
class UpdateAtsApplication2RequestTypedDict(TypedDict):
    ats_application: shared_atsapplication.AtsApplicationTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Application"""
    fields: NotRequired[List[UpdateAtsApplication2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdateAtsApplication2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateAtsApplication2QueryParamFields]],
...
class UpdateAtsApplication2ResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateAtsApplication2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
