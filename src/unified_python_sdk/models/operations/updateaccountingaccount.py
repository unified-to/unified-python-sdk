...
class UpdateAccountingAccountQueryParamFields(str, Enum):
    ID = "id"
...
class UpdateAccountingAccountRequest(BaseModel):
...
class UpdateAccountingAccountResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateAccountingAccountResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
