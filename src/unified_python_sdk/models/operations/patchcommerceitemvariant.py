...
class PatchCommerceItemvariantQueryParamFields(str, Enum):
    ID = "id"
...
class PatchCommerceItemvariantRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[PatchCommerceItemvariantQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class PatchCommerceItemvariantRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchCommerceItemvariantQueryParamFields]],
...
class PatchCommerceItemvariantResponseTypedDict(TypedDict):
    content_type: str
...
class PatchCommerceItemvariantResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
