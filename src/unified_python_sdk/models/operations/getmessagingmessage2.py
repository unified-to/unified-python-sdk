...
class GetMessagingMessage2QueryParamFields(str, Enum):
    ID = "id"
...
class GetMessagingMessage2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Message"""
    fields: NotRequired[List[GetMessagingMessage2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class GetMessagingMessage2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[GetMessagingMessage2QueryParamFields]],
...
class GetMessagingMessage2ResponseTypedDict(TypedDict):
    content_type: str
...
class GetMessagingMessage2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
