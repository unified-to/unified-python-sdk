...
class PatchAtsApplicationQueryParamFields(str, Enum):
    ID = "id"
...
class PatchAtsApplicationRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[PatchAtsApplicationQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class PatchAtsApplicationRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchAtsApplicationQueryParamFields]],
...
class PatchAtsApplicationResponseTypedDict(TypedDict):
    content_type: str
...
class PatchAtsApplicationResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
