...
class UpdateCrmContact2QueryParamFields(str, Enum):
    ID = "id"
...
class UpdateCrmContact2RequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Contact"""
    fields: NotRequired[List[UpdateCrmContact2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdateCrmContact2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateCrmContact2QueryParamFields]],
...
class UpdateCrmContact2ResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateCrmContact2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
