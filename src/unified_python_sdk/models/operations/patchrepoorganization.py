...
class PatchRepoOrganizationQueryParamFields(str, Enum):
    ID = "id"
...
class PatchRepoOrganizationResponseTypedDict(TypedDict):
    content_type: str
...
class PatchRepoOrganizationResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
