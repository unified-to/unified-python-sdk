...
class ListEnrichCompanies2RequestTypedDict(TypedDict):
    connection_id: str
...
class ListEnrichCompanies2Request(BaseModel):
...
class ListEnrichCompanies2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListEnrichCompanies2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
