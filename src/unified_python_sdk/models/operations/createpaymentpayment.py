...
class CreatePaymentPaymentQueryParamFields(str, Enum):
    ID = "id"
...
class CreatePaymentPaymentRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreatePaymentPaymentQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreatePaymentPaymentRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreatePaymentPaymentQueryParamFields]],
