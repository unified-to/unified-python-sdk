...
class GetAtsJobQueryParamFields(str, Enum):
    ID = "id"
...
class GetAtsJobRequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Job"""
    fields: NotRequired[List[GetAtsJobQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class GetAtsJobRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[GetAtsJobQueryParamFields]],
...
class GetAtsJobResponseTypedDict(TypedDict):
    content_type: str
...
class GetAtsJobResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
