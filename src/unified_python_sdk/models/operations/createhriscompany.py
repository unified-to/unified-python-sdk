...
class CreateHrisCompanyQueryParamFields(str, Enum):
    ID = "id"
...
class CreateHrisCompanyRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreateHrisCompanyQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreateHrisCompanyRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateHrisCompanyQueryParamFields]],
