...
class PatchCommerceLocation2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchCommerceLocation2RequestTypedDict(TypedDict):
    commerce_location: shared_commercelocation.CommerceLocationTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Location"""
    fields: NotRequired[List[PatchCommerceLocation2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchCommerceLocation2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchCommerceLocation2QueryParamFields]],
...
class PatchCommerceLocation2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchCommerceLocation2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
