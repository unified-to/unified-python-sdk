...
class GetMessagingMessageQueryParamFields(str, Enum):
    ID = "id"
...
class GetMessagingMessageRequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Message"""
    fields: NotRequired[List[GetMessagingMessageQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class GetMessagingMessageRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[GetMessagingMessageQueryParamFields]],
...
class GetMessagingMessageResponseTypedDict(TypedDict):
    content_type: str
...
class GetMessagingMessageResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
