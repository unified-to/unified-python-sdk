...
class ListAccountingCashflows2QueryParamFields(str, Enum):
    ID = "id"
...
class ListAccountingCashflows2RequestTypedDict(TypedDict):
    connection_id: str
    ...
    fields: NotRequired[List[ListAccountingCashflows2QueryParamFields]]
    r"""Fields to return"""
...
class ListAccountingCashflows2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListAccountingCashflows2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListAccountingCashflows2ResponseTypedDict(TypedDict):
    content_type: str
    ...
    accounting_cashflows: NotRequired[
        List[shared_accountingcashflow.AccountingCashflowTypedDict]
    ]
    r"""Successful"""


class ListAccountingCashflows2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    accounting_cashflows: Optional[
        List[shared_accountingcashflow.AccountingCashflow]
    ] = None
    r"""Successful"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["AccountingCashflows"])
        serialized = handler(self)
        m = {}
