...
class ListAccountingInvoicesQueryParamFields(str, Enum):
    ID = "id"
...
class ListAccountingInvoicesResponseTypedDict(TypedDict):
    content_type: str
...
class ListAccountingInvoicesResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
