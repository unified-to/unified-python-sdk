...
class ListCommerceCollections2QueryParamFields(str, Enum):
    ID = "id"
...
class ListCommerceCollections2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[ListCommerceCollections2QueryParamFields]]
    r"""Fields to return"""
    ...
    r"""The saleschannel ID to filter by (reference to CommerceSaleschannel)"""
...
class ListCommerceCollections2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListCommerceCollections2QueryParamFields]],
...
class ListCommerceCollections2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListCommerceCollections2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["CommerceCollections"])
        serialized = handler(self)
        m = {}
