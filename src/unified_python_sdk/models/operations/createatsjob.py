...
class CreateAtsJobQueryParamFields(str, Enum):
    ID = "id"
...
class CreateAtsJobRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreateAtsJobQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreateAtsJobRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateAtsJobQueryParamFields]],
...
class CreateAtsJobResponseTypedDict(TypedDict):
    content_type: str
...
class CreateAtsJobResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
