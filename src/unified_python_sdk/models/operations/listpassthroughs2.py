...
class ListPassthroughs2RequestTypedDict(TypedDict):
    connection_id: str
...
class ListPassthroughs2Request(BaseModel):
...
class ListPassthroughs2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListPassthroughs2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
