...
class CreateUcContact2QueryParamFields(str, Enum):
    ID = "id"
...
class CreateUcContact2RequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreateUcContact2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class CreateUcContact2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateUcContact2QueryParamFields]],
...
class CreateUcContact2ResponseTypedDict(TypedDict):
    content_type: str
...
class CreateUcContact2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
