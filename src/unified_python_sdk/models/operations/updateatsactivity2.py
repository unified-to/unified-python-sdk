...
class UpdateAtsActivity2QueryParamFields(str, Enum):
    ID = "id"
...
class UpdateAtsActivity2RequestTypedDict(TypedDict):
    ats_activity: shared_atsactivity.AtsActivityTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Activity"""
    fields: NotRequired[List[UpdateAtsActivity2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdateAtsActivity2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateAtsActivity2QueryParamFields]],
...
class UpdateAtsActivity2ResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateAtsActivity2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
