...
class ListMartechReports2QueryParamFields(str, Enum):
    ID = "id"
    START_AT = "start_at"
    END_AT = "end_at"
...
class ListMartechReports2RequestTypedDict(TypedDict):
    connection_id: str
    ...
    fields: NotRequired[List[ListMartechReports2QueryParamFields]]
    r"""Fields to return"""
...
class ListMartechReports2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListMartechReports2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListMartechReports2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListMartechReports2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
