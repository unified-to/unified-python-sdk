...
class PatchAtsJob2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchAtsJob2RequestTypedDict(TypedDict):
    ats_job: shared_atsjob.AtsJobTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Job"""
    fields: NotRequired[List[PatchAtsJob2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchAtsJob2Request(BaseModel):
    ats_job: Annotated[
    ...
    fields: Annotated[
        Optional[List[PatchAtsJob2QueryParamFields]],
...
class PatchAtsJob2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchAtsJob2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
