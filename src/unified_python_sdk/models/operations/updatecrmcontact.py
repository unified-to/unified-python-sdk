...
class UpdateCrmContactQueryParamFields(str, Enum):
    ID = "id"
...
class UpdateCrmContactRequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Contact"""
    fields: NotRequired[List[UpdateCrmContactQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdateCrmContactRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateCrmContactQueryParamFields]],
...
class UpdateCrmContactResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateCrmContactResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
