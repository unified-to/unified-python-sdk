...
class ListAdsCampaignsQueryParamFields(str, Enum):
    ID = "id"
...
class ListAdsCampaignsRequest(BaseModel):
...
class ListAdsCampaignsResponseTypedDict(TypedDict):
    content_type: str
...
class ListAdsCampaignsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
