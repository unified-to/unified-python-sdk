...
class UpdateMartechMember2QueryParamFields(str, Enum):
    ID = "id"
...
class UpdateMartechMember2RequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Member"""
    fields: NotRequired[List[UpdateMartechMember2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdateMartechMember2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateMartechMember2QueryParamFields]],
...
class UpdateMartechMember2ResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateMartechMember2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
