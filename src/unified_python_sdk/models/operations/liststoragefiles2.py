...
class ListStorageFiles2QueryParamFields(str, Enum):
    ID = "id"
...
class ListStorageFiles2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    expand: NotRequired[bool]
    r"""Whether to flatten grouped or recurring items into individual entries."""
    fields: NotRequired[List[ListStorageFiles2QueryParamFields]]
    r"""Fields to return"""
...
class ListStorageFiles2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListStorageFiles2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListStorageFiles2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListStorageFiles2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
