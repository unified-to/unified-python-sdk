...
class ListRepoCommitsQueryParamFields(str, Enum):
    ID = "id"
...
class ListRepoCommitsRequestTypedDict(TypedDict):
    connection_id: str
...
class ListRepoCommitsRequest(BaseModel):
...
class ListRepoCommitsResponseTypedDict(TypedDict):
    content_type: str
