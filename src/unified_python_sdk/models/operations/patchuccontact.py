...
class PatchUcContactQueryParamFields(str, Enum):
    ID = "id"
...
class PatchUcContactRequestTypedDict(TypedDict):
...
class PatchUcContactRequest(BaseModel):
...
class PatchUcContactResponseTypedDict(TypedDict):
    content_type: str
...
class PatchUcContactResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
