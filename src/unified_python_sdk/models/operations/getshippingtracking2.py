...
class GetShippingTracking2QueryParamFields(str, Enum):
    ID = "id"
...
class GetShippingTracking2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Tracking"""
    fields: NotRequired[List[GetShippingTracking2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class GetShippingTracking2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[GetShippingTracking2QueryParamFields]],
...
class GetShippingTracking2ResponseTypedDict(TypedDict):
    content_type: str
...
class GetShippingTracking2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
