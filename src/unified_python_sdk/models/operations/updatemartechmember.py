...
class UpdateMartechMemberQueryParamFields(str, Enum):
    ID = "id"
...
class UpdateMartechMemberRequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Member"""
    fields: NotRequired[List[UpdateMartechMemberQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class UpdateMartechMemberRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateMartechMemberQueryParamFields]],
