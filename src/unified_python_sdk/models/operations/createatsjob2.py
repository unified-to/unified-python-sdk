...
class CreateAtsJob2QueryParamFields(str, Enum):
    ID = "id"
...
class CreateAtsJob2RequestTypedDict(TypedDict):
    ats_job: shared_atsjob.AtsJobTypedDict
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[CreateAtsJob2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class CreateAtsJob2Request(BaseModel):
    ats_job: Annotated[
    ...
    fields: Annotated[
        Optional[List[CreateAtsJob2QueryParamFields]],
...
class CreateAtsJob2ResponseTypedDict(TypedDict):
    content_type: str
...
class CreateAtsJob2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
