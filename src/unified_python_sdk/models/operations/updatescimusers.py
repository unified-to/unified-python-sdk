...
class UpdateScimUsersRequestTypedDict(TypedDict):
...
class UpdateScimUsersRequest(BaseModel):
    scim_user: Annotated[
...
class UpdateScimUsersResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateScimUsersResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
