...
class UpdateAccountingAccount2QueryParamFields(str, Enum):
    ID = "id"
...
class UpdateAccountingAccount2RequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Account"""
    fields: NotRequired[List[UpdateAccountingAccount2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdateAccountingAccount2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateAccountingAccount2QueryParamFields]],
...
class UpdateAccountingAccount2ResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateAccountingAccount2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
