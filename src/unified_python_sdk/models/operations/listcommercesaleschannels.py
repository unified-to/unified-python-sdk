...
class ListCommerceSaleschannelsQueryParamFields(str, Enum):
    ID = "id"
...
class ListCommerceSaleschannelsRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[ListCommerceSaleschannelsQueryParamFields]]
    r"""Fields to return"""
...
class ListCommerceSaleschannelsRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListCommerceSaleschannelsQueryParamFields]],
