...
class GetAtsJob2QueryParamFields(str, Enum):
    ID = "id"
...
class GetAtsJob2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Job"""
    fields: NotRequired[List[GetAtsJob2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class GetAtsJob2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[GetAtsJob2QueryParamFields]],
...
class GetAtsJob2ResponseTypedDict(TypedDict):
    content_type: str
...
class GetAtsJob2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
