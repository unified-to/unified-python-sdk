...
class PatchMartechMemberQueryParamFields(str, Enum):
    ID = "id"
...
class PatchMartechMemberRequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Member"""
    fields: NotRequired[List[PatchMartechMemberQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchMartechMemberRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchMartechMemberQueryParamFields]],
...
class PatchMartechMemberResponseTypedDict(TypedDict):
    content_type: str
...
class PatchMartechMemberResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
