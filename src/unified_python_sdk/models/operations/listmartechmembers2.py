...
class ListMartechMembers2QueryParamFields(str, Enum):
    ID = "id"
...
class ListMartechMembers2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[ListMartechMembers2QueryParamFields]]
    r"""Fields to return"""
...
class ListMartechMembers2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListMartechMembers2QueryParamFields]],
...
class ListMartechMembers2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListMartechMembers2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
