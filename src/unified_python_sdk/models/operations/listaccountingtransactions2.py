...
class ListAccountingTransactions2QueryParamFields(str, Enum):
    ID = "id"
...
class ListAccountingTransactions2RequestTypedDict(TypedDict):
    connection_id: str
    ...
    fields: NotRequired[List[ListAccountingTransactions2QueryParamFields]]
    r"""Fields to return"""
...
class ListAccountingTransactions2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListAccountingTransactions2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListAccountingTransactions2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListAccountingTransactions2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
