...
class PatchMartechMember2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchMartechMember2RequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Member"""
    fields: NotRequired[List[PatchMartechMember2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchMartechMember2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchMartechMember2QueryParamFields]],
...
class PatchMartechMember2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchMartechMember2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
