...
class UpdatePaymentSubscriptionQueryParamFields(str, Enum):
    ID = "id"
...
class UpdatePaymentSubscriptionRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[UpdatePaymentSubscriptionQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class UpdatePaymentSubscriptionRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdatePaymentSubscriptionQueryParamFields]],
