...
class ListVerificationRequestsQueryParamFields(str, Enum):
    ID = "id"
...
class ListVerificationRequestsRequestTypedDict(TypedDict):
    connection_id: str
...
class ListVerificationRequestsRequest(BaseModel):
...
class ListVerificationRequestsResponseTypedDict(TypedDict):
    content_type: str
...
class ListVerificationRequestsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
