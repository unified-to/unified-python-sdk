...
class CreateAccountingContactQueryParamFields(str, Enum):
    ID = "id"
...
class CreateAccountingContactRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreateAccountingContactQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreateAccountingContactRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateAccountingContactQueryParamFields]],
