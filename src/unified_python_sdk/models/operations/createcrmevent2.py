...
class CreateCrmEvent2QueryParamFields(str, Enum):
    ID = "id"
...
class CreateCrmEvent2RequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreateCrmEvent2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class CreateCrmEvent2Request(BaseModel):
    crm_event: Annotated[
    ...
    fields: Annotated[
        Optional[List[CreateCrmEvent2QueryParamFields]],
...
class CreateCrmEvent2ResponseTypedDict(TypedDict):
    content_type: str
...
class CreateCrmEvent2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
