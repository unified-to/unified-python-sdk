...
class CreateHrisEmployeeQueryParamFields(str, Enum):
    ID = "id"
...
class CreateHrisEmployeeRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreateHrisEmployeeQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreateHrisEmployeeRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateHrisEmployeeQueryParamFields]],
