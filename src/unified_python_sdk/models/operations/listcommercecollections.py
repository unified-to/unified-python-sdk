...
class ListCommerceCollectionsQueryParamFields(str, Enum):
    ID = "id"
...
class ListCommerceCollectionsRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[ListCommerceCollectionsQueryParamFields]]
    r"""Fields to return"""
...
class ListCommerceCollectionsRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListCommerceCollectionsQueryParamFields]],
