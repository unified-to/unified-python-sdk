...
class ListAccountingExpenses2QueryParamFields(str, Enum):
    ID = "id"
...
class ListAccountingExpenses2RequestTypedDict(TypedDict):
    connection_id: str
    ...
    fields: NotRequired[List[ListAccountingExpenses2QueryParamFields]]
    r"""Fields to return"""
...
class ListAccountingExpenses2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListAccountingExpenses2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListAccountingExpenses2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListAccountingExpenses2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
