...
class CreateCommerceCollectionQueryParamFields(str, Enum):
    ID = "id"
...
class CreateCommerceCollectionRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreateCommerceCollectionQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreateCommerceCollectionRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateCommerceCollectionQueryParamFields]],
...
class CreateCommerceCollectionResponseTypedDict(TypedDict):
    content_type: str
...
class CreateCommerceCollectionResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
