...
class PatchTicketingTicketQueryParamFields(str, Enum):
    ID = "id"
...
class PatchTicketingTicketRequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Ticket"""
    fields: NotRequired[List[PatchTicketingTicketQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class PatchTicketingTicketRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchTicketingTicketQueryParamFields]],
