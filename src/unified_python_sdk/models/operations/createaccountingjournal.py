...
class CreateAccountingJournalQueryParamFields(str, Enum):
    ID = "id"
...
class CreateAccountingJournalRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreateAccountingJournalQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreateAccountingJournalRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateAccountingJournalQueryParamFields]],
...
class CreateAccountingJournalResponseTypedDict(TypedDict):
    content_type: str
...
class CreateAccountingJournalResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
