...
class PatchPaymentSubscription2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchPaymentSubscription2RequestTypedDict(TypedDict):
    payment_subscription: shared_paymentsubscription.PaymentSubscriptionTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Subscription"""
    fields: NotRequired[List[PatchPaymentSubscription2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchPaymentSubscription2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchPaymentSubscription2QueryParamFields]],
...
class PatchPaymentSubscription2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchPaymentSubscription2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
