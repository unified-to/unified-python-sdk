...
class ListEnrichPeople2RequestTypedDict(TypedDict):
    connection_id: str
...
class ListEnrichPeople2Request(BaseModel):
...
class ListEnrichPeople2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListEnrichPeople2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
