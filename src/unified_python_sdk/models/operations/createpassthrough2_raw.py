...
class CreatePassthrough2RawRequestTypedDict(TypedDict):
    connection_id: str
...
class CreatePassthrough2RawRequest(BaseModel):
...
class CreatePassthrough2RawResponseTypedDict(TypedDict):
    content_type: str
...
class CreatePassthrough2RawResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
