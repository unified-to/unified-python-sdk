...
class UpdateCommerceLocation2QueryParamFields(str, Enum):
    ID = "id"
...
class UpdateCommerceLocation2RequestTypedDict(TypedDict):
    commerce_location: shared_commercelocation.CommerceLocationTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Location"""
    fields: NotRequired[List[UpdateCommerceLocation2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdateCommerceLocation2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateCommerceLocation2QueryParamFields]],
...
class UpdateCommerceLocation2ResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateCommerceLocation2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["CommerceLocation"])
        serialized = handler(self)
        m = {}
