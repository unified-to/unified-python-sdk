...
class PatchShippingLabel2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchShippingLabel2RequestTypedDict(TypedDict):
    shipping_label: shared_shippinglabel.ShippingLabelTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Label"""
    fields: NotRequired[List[PatchShippingLabel2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchShippingLabel2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchShippingLabel2QueryParamFields]],
...
class PatchShippingLabel2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchShippingLabel2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
