...
class ListTicketingTicketsQueryParamFields(str, Enum):
    ID = "id"
...
class ListTicketingTicketsRequestTypedDict(TypedDict):
    connection_id: str
...
class ListTicketingTicketsRequest(BaseModel):
...
class ListTicketingTicketsResponseTypedDict(TypedDict):
    content_type: str
...
class ListTicketingTicketsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
