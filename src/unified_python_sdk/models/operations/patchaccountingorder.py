...
class PatchAccountingOrderQueryParamFields(str, Enum):
    ID = "id"
...
class PatchAccountingOrderRequestTypedDict(TypedDict):
    accounting_order: shared_accountingorder.AccountingOrderTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Order"""
    fields: NotRequired[List[PatchAccountingOrderQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchAccountingOrderRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchAccountingOrderQueryParamFields]],
...
class PatchAccountingOrderResponseTypedDict(TypedDict):
    content_type: str
...
class PatchAccountingOrderResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
