...
class PatchAccountingTransaction2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchAccountingTransaction2RequestTypedDict(TypedDict):
    accounting_transaction: shared_accountingtransaction.AccountingTransactionTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Transaction"""
    fields: NotRequired[List[PatchAccountingTransaction2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchAccountingTransaction2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchAccountingTransaction2QueryParamFields]],
...
class PatchAccountingTransaction2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchAccountingTransaction2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
