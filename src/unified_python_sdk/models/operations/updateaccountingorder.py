...
class UpdateAccountingOrderQueryParamFields(str, Enum):
    ID = "id"
...
class UpdateAccountingOrderRequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Order"""
    fields: NotRequired[List[UpdateAccountingOrderQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class UpdateAccountingOrderRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateAccountingOrderQueryParamFields]],
