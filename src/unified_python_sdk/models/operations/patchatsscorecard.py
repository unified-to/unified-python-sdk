...
class PatchAtsScorecardQueryParamFields(str, Enum):
    ID = "id"
...
class PatchAtsScorecardRequestTypedDict(TypedDict):
    ats_scorecard: shared_atsscorecard.AtsScorecardTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Scorecard"""
    fields: NotRequired[List[PatchAtsScorecardQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchAtsScorecardRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchAtsScorecardQueryParamFields]],
...
class PatchAtsScorecardResponseTypedDict(TypedDict):
    content_type: str
...
class PatchAtsScorecardResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
