...
class ListAccountingTrialbalancesQueryParamFields(str, Enum):
    ID = "id"
...
class ListAccountingTrialbalancesRequestTypedDict(TypedDict):
    connection_id: str
...
class ListAccountingTrialbalancesRequest(BaseModel):
...
class ListAccountingTrialbalancesResponseTypedDict(TypedDict):
    content_type: str
...
class ListAccountingTrialbalancesResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
