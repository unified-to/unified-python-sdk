...
class CreatePaymentLinkQueryParamFields(str, Enum):
    ID = "id"
...
class CreatePaymentLinkRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreatePaymentLinkQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreatePaymentLinkRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreatePaymentLinkQueryParamFields]],
