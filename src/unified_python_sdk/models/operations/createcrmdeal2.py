...
class CreateCrmDeal2QueryParamFields(str, Enum):
    ID = "id"
...
class CreateCrmDeal2RequestTypedDict(TypedDict):
    crm_deal: shared_crmdeal.CrmDealTypedDict
    r"""A deal represents an opportunity with companies and/or contacts"""
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[CreateCrmDeal2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class CreateCrmDeal2Request(BaseModel):
    crm_deal: Annotated[
    ...
    fields: Annotated[
        Optional[List[CreateCrmDeal2QueryParamFields]],
...
class CreateCrmDeal2ResponseTypedDict(TypedDict):
    content_type: str
...
class CreateCrmDeal2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
