...
class ListMetadataMetadatas2QueryParamFields(str, Enum):
    ID = "id"
...
class ListMetadataMetadatas2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[ListMetadataMetadatas2QueryParamFields]]
    r"""Fields to return"""
...
class ListMetadataMetadatas2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListMetadataMetadatas2QueryParamFields]],
...
class ListMetadataMetadatas2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListMetadataMetadatas2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["MetadataMetadatas"])
        serialized = handler(self)
        m = {}
