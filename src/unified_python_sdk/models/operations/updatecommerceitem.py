...
class UpdateCommerceItemQueryParamFields(str, Enum):
    ID = "id"
...
class UpdateCommerceItemRequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Item"""
    fields: NotRequired[List[UpdateCommerceItemQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdateCommerceItemRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateCommerceItemQueryParamFields]],
...
class UpdateCommerceItemResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateCommerceItemResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
