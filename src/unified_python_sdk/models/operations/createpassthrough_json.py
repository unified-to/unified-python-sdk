...
class CreatePassthroughJSONRequestTypedDict(TypedDict):
    connection_id: str
...
class CreatePassthroughJSONRequest(BaseModel):
...
class CreatePassthroughJSONResponseTypedDict(TypedDict):
    content_type: str
...
class CreatePassthroughJSONResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
