...
class PatchAccountingAccount2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchAccountingAccount2RequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Account"""
    fields: NotRequired[List[PatchAccountingAccount2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchAccountingAccount2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchAccountingAccount2QueryParamFields]],
...
class PatchAccountingAccount2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchAccountingAccount2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
