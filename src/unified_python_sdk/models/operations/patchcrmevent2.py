...
class PatchCrmEvent2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchCrmEvent2RequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Event"""
    fields: NotRequired[List[PatchCrmEvent2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchCrmEvent2Request(BaseModel):
    crm_event: Annotated[
    ...
    fields: Annotated[
        Optional[List[PatchCrmEvent2QueryParamFields]],
...
class PatchCrmEvent2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchCrmEvent2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
