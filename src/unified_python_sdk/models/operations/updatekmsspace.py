...
class UpdateKmsSpaceQueryParamFields(str, Enum):
    ID = "id"
...
class UpdateKmsSpaceRequestTypedDict(TypedDict):
...
class UpdateKmsSpaceRequest(BaseModel):
    kms_space: Annotated[
...
class UpdateKmsSpaceResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateKmsSpaceResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
