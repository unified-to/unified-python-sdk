...
class CreateCommerceLocationQueryParamFields(str, Enum):
    ID = "id"
...
class CreateCommerceLocationRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreateCommerceLocationQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreateCommerceLocationRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateCommerceLocationQueryParamFields]],
...
class CreateCommerceLocationResponseTypedDict(TypedDict):
    content_type: str
...
class CreateCommerceLocationResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
