...
class GetAccountingInvoiceQueryParamFields(str, Enum):
    ID = "id"
...
class GetAccountingInvoiceRequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Invoice"""
    fields: NotRequired[List[GetAccountingInvoiceQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class GetAccountingInvoiceRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[GetAccountingInvoiceQueryParamFields]],
...
class GetAccountingInvoiceResponseTypedDict(TypedDict):
    content_type: str
...
class GetAccountingInvoiceResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
