...
class ListAtsActivities2QueryParamFields(str, Enum):
    ID = "id"
...
class ListAtsActivities2RequestTypedDict(TypedDict):
    connection_id: str
    ...
    fields: NotRequired[List[ListAtsActivities2QueryParamFields]]
    r"""Fields to return"""
...
class ListAtsActivities2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListAtsActivities2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListAtsActivities2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListAtsActivities2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["AtsActivities"])
        serialized = handler(self)
        m = {}
