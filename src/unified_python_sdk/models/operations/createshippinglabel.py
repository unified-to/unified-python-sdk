...
class CreateShippingLabelQueryParamFields(str, Enum):
    ID = "id"
...
class CreateShippingLabelRequestTypedDict(TypedDict):
    shipping_label: shared_shippinglabel.ShippingLabelTypedDict
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[CreateShippingLabelQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreateShippingLabelRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateShippingLabelQueryParamFields]],
...
class CreateShippingLabelResponseTypedDict(TypedDict):
    content_type: str
...
class CreateShippingLabelResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
