...
class PatchRepoRepositoryQueryParamFields(str, Enum):
    ID = "id"
...
class PatchRepoRepositoryRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[PatchRepoRepositoryQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class PatchRepoRepositoryRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchRepoRepositoryQueryParamFields]],
