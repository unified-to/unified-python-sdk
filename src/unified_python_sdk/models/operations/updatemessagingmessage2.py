...
class UpdateMessagingMessage2QueryParamFields(str, Enum):
    ID = "id"
...
class UpdateMessagingMessage2RequestTypedDict(TypedDict):
    messaging_message: shared_messagingmessage.MessagingMessageTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Message"""
    fields: NotRequired[List[UpdateMessagingMessage2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdateMessagingMessage2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateMessagingMessage2QueryParamFields]],
...
class UpdateMessagingMessage2ResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateMessagingMessage2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
