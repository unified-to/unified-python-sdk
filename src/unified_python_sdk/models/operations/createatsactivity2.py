...
class CreateAtsActivity2QueryParamFields(str, Enum):
    ID = "id"
...
class CreateAtsActivity2RequestTypedDict(TypedDict):
    ats_activity: shared_atsactivity.AtsActivityTypedDict
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[CreateAtsActivity2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class CreateAtsActivity2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateAtsActivity2QueryParamFields]],
...
class CreateAtsActivity2ResponseTypedDict(TypedDict):
    content_type: str
...
class CreateAtsActivity2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
