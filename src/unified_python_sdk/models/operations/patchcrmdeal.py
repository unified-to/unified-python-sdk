...
class PatchCrmDealQueryParamFields(str, Enum):
    ID = "id"
...
class PatchCrmDealRequest(BaseModel):
    crm_deal: Annotated[
...
class PatchCrmDealResponseTypedDict(TypedDict):
    content_type: str
...
class PatchCrmDealResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
