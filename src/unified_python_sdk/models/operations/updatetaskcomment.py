...
class UpdateTaskCommentQueryParamFields(str, Enum):
    ID = "id"
...
class UpdateTaskCommentRequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Comment"""
    fields: NotRequired[List[UpdateTaskCommentQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class UpdateTaskCommentRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateTaskCommentQueryParamFields]],
