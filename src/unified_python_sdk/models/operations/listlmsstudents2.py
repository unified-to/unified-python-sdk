...
class ListLmsStudents2QueryParamFields(str, Enum):
    ID = "id"
...
class ListLmsStudents2RequestTypedDict(TypedDict):
    connection_id: str
    ...
    fields: NotRequired[List[ListLmsStudents2QueryParamFields]]
    r"""Fields to return"""
...
class ListLmsStudents2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListLmsStudents2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListLmsStudents2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListLmsStudents2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["LmsStudents"])
        serialized = handler(self)
        m = {}
