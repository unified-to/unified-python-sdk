...
class PatchRepoOrganization2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchRepoOrganization2RequestTypedDict(TypedDict):
    repo_organization: shared_repoorganization.RepoOrganizationTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Organization"""
    fields: NotRequired[List[PatchRepoOrganization2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchRepoOrganization2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchRepoOrganization2QueryParamFields]],
...
class PatchRepoOrganization2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchRepoOrganization2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
