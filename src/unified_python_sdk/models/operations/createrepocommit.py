...
class CreateRepoCommitQueryParamFields(str, Enum):
    ID = "id"
...
class CreateRepoCommitRequestTypedDict(TypedDict):
    repo_commit: shared_repocommit.RepoCommitTypedDict
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[CreateRepoCommitQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreateRepoCommitRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateRepoCommitQueryParamFields]],
...
class CreateRepoCommitResponseTypedDict(TypedDict):
    content_type: str
