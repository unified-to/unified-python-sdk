...
class ListHrisTimeshifts2QueryParamFields(str, Enum):
    ID = "id"
...
class ListHrisTimeshifts2RequestTypedDict(TypedDict):
    connection_id: str
    ...
    fields: NotRequired[List[ListHrisTimeshifts2QueryParamFields]]
    r"""Fields to return"""
...
class ListHrisTimeshifts2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListHrisTimeshifts2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListHrisTimeshifts2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListHrisTimeshifts2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
