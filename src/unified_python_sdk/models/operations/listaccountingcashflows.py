...
class ListAccountingCashflowsQueryParamFields(str, Enum):
    ID = "id"
...
class ListAccountingCashflowsRequestTypedDict(TypedDict):
    connection_id: str
    ...
    fields: NotRequired[List[ListAccountingCashflowsQueryParamFields]]
    r"""Fields to return"""
...
class ListAccountingCashflowsRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListAccountingCashflowsQueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListAccountingCashflowsResponseTypedDict(TypedDict):
    content_type: str
...
class ListAccountingCashflowsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
