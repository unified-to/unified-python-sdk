...
class UpdateRepoCommitQueryParamFields(str, Enum):
    ID = "id"
...
class UpdateRepoCommitRequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Commit"""
    fields: NotRequired[List[UpdateRepoCommitQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class UpdateRepoCommitRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateRepoCommitQueryParamFields]],
...
class UpdateRepoCommitResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateRepoCommitResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
