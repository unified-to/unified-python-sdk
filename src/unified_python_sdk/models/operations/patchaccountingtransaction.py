...
class PatchAccountingTransactionQueryParamFields(str, Enum):
    ID = "id"
...
class PatchAccountingTransactionRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[PatchAccountingTransactionQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class PatchAccountingTransactionRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchAccountingTransactionQueryParamFields]],
...
class PatchAccountingTransactionResponseTypedDict(TypedDict):
    content_type: str
...
class PatchAccountingTransactionResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
