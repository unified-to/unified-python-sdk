...
class PatchAccountingInvoice2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchAccountingInvoice2RequestTypedDict(TypedDict):
    accounting_invoice: shared_accountinginvoice.AccountingInvoiceTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Invoice"""
    fields: NotRequired[List[PatchAccountingInvoice2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchAccountingInvoice2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchAccountingInvoice2QueryParamFields]],
...
class PatchAccountingInvoice2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchAccountingInvoice2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
