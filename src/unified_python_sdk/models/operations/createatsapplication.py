...
class CreateAtsApplicationQueryParamFields(str, Enum):
    ID = "id"
...
class CreateAtsApplicationRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreateAtsApplicationQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreateAtsApplicationRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateAtsApplicationQueryParamFields]],
