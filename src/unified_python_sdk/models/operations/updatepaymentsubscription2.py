...
class UpdatePaymentSubscription2QueryParamFields(str, Enum):
    ID = "id"
...
class UpdatePaymentSubscription2RequestTypedDict(TypedDict):
    payment_subscription: shared_paymentsubscription.PaymentSubscriptionTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Subscription"""
    fields: NotRequired[List[UpdatePaymentSubscription2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdatePaymentSubscription2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdatePaymentSubscription2QueryParamFields]],
...
class UpdatePaymentSubscription2ResponseTypedDict(TypedDict):
    content_type: str
...
class UpdatePaymentSubscription2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
