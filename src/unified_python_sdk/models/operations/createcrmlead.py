...
class CreateCrmLeadQueryParamFields(str, Enum):
    ID = "id"
...
class CreateCrmLeadRequestTypedDict(TypedDict):
    crm_lead: shared_crmlead.CrmLeadTypedDict
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[CreateCrmLeadQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreateCrmLeadRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateCrmLeadQueryParamFields]],
...
class CreateCrmLeadResponseTypedDict(TypedDict):
    content_type: str
...
class CreateCrmLeadResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
