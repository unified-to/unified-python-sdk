...
class ListUcRecordings2QueryParamFields(str, Enum):
    ID = "id"
...
class ListUcRecordings2RequestTypedDict(TypedDict):
    connection_id: str
    ...
    fields: NotRequired[List[ListUcRecordings2QueryParamFields]]
    r"""Fields to return"""
...
class ListUcRecordings2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListUcRecordings2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListUcRecordings2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListUcRecordings2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
