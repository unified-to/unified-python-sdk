...
class PatchAccountingInvoiceQueryParamFields(str, Enum):
    ID = "id"
...
class PatchAccountingInvoiceRequestTypedDict(TypedDict):
...
class PatchAccountingInvoiceRequest(BaseModel):
...
class PatchAccountingInvoiceResponseTypedDict(TypedDict):
    content_type: str
...
class PatchAccountingInvoiceResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
