...
class CreateAccountingContact2QueryParamFields(str, Enum):
    ID = "id"
...
class CreateAccountingContact2RequestTypedDict(TypedDict):
    accounting_contact: shared_accountingcontact.AccountingContactTypedDict
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[CreateAccountingContact2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class CreateAccountingContact2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateAccountingContact2QueryParamFields]],
...
class CreateAccountingContact2ResponseTypedDict(TypedDict):
    content_type: str
...
class CreateAccountingContact2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
