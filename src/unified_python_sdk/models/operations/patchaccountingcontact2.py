...
class PatchAccountingContact2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchAccountingContact2RequestTypedDict(TypedDict):
    accounting_contact: shared_accountingcontact.AccountingContactTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Contact"""
    fields: NotRequired[List[PatchAccountingContact2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchAccountingContact2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchAccountingContact2QueryParamFields]],
...
class PatchAccountingContact2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchAccountingContact2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
