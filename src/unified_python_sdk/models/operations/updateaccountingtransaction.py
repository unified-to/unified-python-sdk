...
class UpdateAccountingTransactionQueryParamFields(str, Enum):
    ID = "id"
...
class UpdateAccountingTransactionRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[UpdateAccountingTransactionQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class UpdateAccountingTransactionRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateAccountingTransactionQueryParamFields]],
