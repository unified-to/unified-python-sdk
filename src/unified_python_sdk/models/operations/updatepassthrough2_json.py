...
class UpdatePassthrough2JSONRequestTypedDict(TypedDict):
    connection_id: str
...
class UpdatePassthrough2JSONRequest(BaseModel):
...
class UpdatePassthrough2JSONResponseTypedDict(TypedDict):
    content_type: str
...
class UpdatePassthrough2JSONResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
