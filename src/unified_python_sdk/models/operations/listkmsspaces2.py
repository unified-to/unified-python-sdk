...
class ListKmsSpaces2QueryParamFields(str, Enum):
    ID = "id"
...
class ListKmsSpaces2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[ListKmsSpaces2QueryParamFields]]
    r"""Fields to return"""
...
class ListKmsSpaces2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListKmsSpaces2QueryParamFields]],
...
class ListKmsSpaces2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListKmsSpaces2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
