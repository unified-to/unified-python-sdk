...
class CreateCommerceItemvariantQueryParamFields(str, Enum):
    ID = "id"
...
class CreateCommerceItemvariantRequestTypedDict(TypedDict):
    commerce_itemvariant: shared_commerceitemvariant1.CommerceItemvariant1TypedDict
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[CreateCommerceItemvariantQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class CreateCommerceItemvariantRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateCommerceItemvariantQueryParamFields]],
...
class CreateCommerceItemvariantResponseTypedDict(TypedDict):
    content_type: str
...
class CreateCommerceItemvariantResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
