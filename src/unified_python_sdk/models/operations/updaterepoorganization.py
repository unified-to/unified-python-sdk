...
class UpdateRepoOrganizationQueryParamFields(str, Enum):
    ID = "id"
...
class UpdateRepoOrganizationRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[UpdateRepoOrganizationQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class UpdateRepoOrganizationRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateRepoOrganizationQueryParamFields]],
