...
class ListAccountingProfitlosses2QueryParamFields(str, Enum):
    ID = "id"
...
class ListAccountingProfitlosses2RequestTypedDict(TypedDict):
    connection_id: str
    ...
    fields: NotRequired[List[ListAccountingProfitlosses2QueryParamFields]]
    r"""Fields to return"""
...
class ListAccountingProfitlosses2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListAccountingProfitlosses2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListAccountingProfitlosses2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListAccountingProfitlosses2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
