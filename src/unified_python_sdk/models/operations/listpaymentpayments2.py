...
class ListPaymentPayments2QueryParamFields(str, Enum):
    ID = "id"
...
class ListPaymentPayments2RequestTypedDict(TypedDict):
    connection_id: str
    ...
    fields: NotRequired[List[ListPaymentPayments2QueryParamFields]]
    r"""Fields to return"""
...
class ListPaymentPayments2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListPaymentPayments2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListPaymentPayments2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListPaymentPayments2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
