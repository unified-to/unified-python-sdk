...
class UpdateAccountingInvoiceQueryParamFields(str, Enum):
    ID = "id"
...
class UpdateAccountingInvoiceRequestTypedDict(TypedDict):
    accounting_invoice: shared_accountinginvoice.AccountingInvoiceTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Invoice"""
    fields: NotRequired[List[UpdateAccountingInvoiceQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdateAccountingInvoiceRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateAccountingInvoiceQueryParamFields]],
...
class UpdateAccountingInvoiceResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateAccountingInvoiceResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
