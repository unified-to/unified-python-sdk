...
class PatchPassthrough2JSONRequestTypedDict(TypedDict):
    connection_id: str
...
class PatchPassthrough2JSONRequest(BaseModel):
...
class PatchPassthrough2JSONResponseTypedDict(TypedDict):
    content_type: str
...
class PatchPassthrough2JSONResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
