...
class UpdateMetadataMetadata2QueryParamFields(str, Enum):
    ID = "id"
...
class UpdateMetadataMetadata2RequestTypedDict(TypedDict):
    metadata_metadata: shared_metadatametadata.MetadataMetadataTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Metadata"""
    fields: NotRequired[List[UpdateMetadataMetadata2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdateMetadataMetadata2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateMetadataMetadata2QueryParamFields]],
...
class UpdateMetadataMetadata2ResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateMetadataMetadata2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
