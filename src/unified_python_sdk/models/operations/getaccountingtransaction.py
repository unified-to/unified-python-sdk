...
class GetAccountingTransactionQueryParamFields(str, Enum):
    ID = "id"
...
class GetAccountingTransactionRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[GetAccountingTransactionQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class GetAccountingTransactionRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[GetAccountingTransactionQueryParamFields]],
