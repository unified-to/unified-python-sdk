...
class PatchPaymentLink2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchPaymentLink2RequestTypedDict(TypedDict):
    payment_link: shared_paymentlink.PaymentLinkTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Link"""
    fields: NotRequired[List[PatchPaymentLink2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchPaymentLink2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchPaymentLink2QueryParamFields]],
...
class PatchPaymentLink2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchPaymentLink2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
