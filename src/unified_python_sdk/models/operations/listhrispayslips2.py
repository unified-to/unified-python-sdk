...
class ListHrisPayslips2QueryParamFields(str, Enum):
    ID = "id"
...
class ListHrisPayslips2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    company_id: NotRequired[str]
    r"""The company ID to filter by (reference to HrisCompany)"""
    fields: NotRequired[List[ListHrisPayslips2QueryParamFields]]
    r"""Fields to return"""
...
class ListHrisPayslips2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListHrisPayslips2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListHrisPayslips2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListHrisPayslips2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
