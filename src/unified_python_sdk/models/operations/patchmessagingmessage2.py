...
class PatchMessagingMessage2QueryParamFields(str, Enum):
    ID = "id"
...
class PatchMessagingMessage2RequestTypedDict(TypedDict):
    messaging_message: shared_messagingmessage.MessagingMessageTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Message"""
    fields: NotRequired[List[PatchMessagingMessage2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class PatchMessagingMessage2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchMessagingMessage2QueryParamFields]],
...
class PatchMessagingMessage2ResponseTypedDict(TypedDict):
    content_type: str
...
class PatchMessagingMessage2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
