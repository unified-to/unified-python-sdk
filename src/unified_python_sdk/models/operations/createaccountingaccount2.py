...
class CreateAccountingAccount2RequestTypedDict(TypedDict):
...
class CreateAccountingAccount2Request(BaseModel):
...
class CreateAccountingAccount2ResponseTypedDict(TypedDict):
    content_type: str
...
class CreateAccountingAccount2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
