...
class GetAtsApplicationQueryParamFields(str, Enum):
    ID = "id"
...
class GetAtsApplicationRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[GetAtsApplicationQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class GetAtsApplicationRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[GetAtsApplicationQueryParamFields]],
