...
class ListKmsPagesQueryParamFields(str, Enum):
    ID = "id"
...
class ListKmsPagesRequestTypedDict(TypedDict):
    connection_id: str
...
class ListKmsPagesResponseTypedDict(TypedDict):
    content_type: str
...
class ListKmsPagesResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
