...
class ListAccountingContacts2QueryParamFields(str, Enum):
    ID = "id"
...
class ListAccountingContacts2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[ListAccountingContacts2QueryParamFields]]
    r"""Fields to return"""
...
class ListAccountingContacts2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListAccountingContacts2QueryParamFields]],
...
class ListAccountingContacts2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListAccountingContacts2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
