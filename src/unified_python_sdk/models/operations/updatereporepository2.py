...
class UpdateRepoRepository2QueryParamFields(str, Enum):
    ID = "id"
...
class UpdateRepoRepository2RequestTypedDict(TypedDict):
    repo_repository: shared_reporepository.RepoRepositoryTypedDict
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Repository"""
    fields: NotRequired[List[UpdateRepoRepository2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdateRepoRepository2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateRepoRepository2QueryParamFields]],
...
class UpdateRepoRepository2ResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateRepoRepository2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
