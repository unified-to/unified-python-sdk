...
class PatchCommerceCollectionQueryParamFields(str, Enum):
    ID = "id"
...
class PatchCommerceCollectionRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[PatchCommerceCollectionQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class PatchCommerceCollectionRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchCommerceCollectionQueryParamFields]],
...
class PatchCommerceCollectionResponseTypedDict(TypedDict):
    content_type: str
...
class PatchCommerceCollectionResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
