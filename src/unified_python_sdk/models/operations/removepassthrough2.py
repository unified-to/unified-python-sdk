...
class RemovePassthrough2RequestTypedDict(TypedDict):
    connection_id: str
...
class RemovePassthrough2Request(BaseModel):
...
class RemovePassthrough2ResponseTypedDict(TypedDict):
    content_type: str
...
class RemovePassthrough2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
