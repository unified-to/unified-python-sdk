...
class ListCommerceItemvariantsQueryParamFields(str, Enum):
    ID = "id"
...
class ListCommerceItemvariantsRequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    collection_id: NotRequired[str]
    r"""The collection ID to filter by (reference to CommerceCollection)"""
    fields: NotRequired[List[ListCommerceItemvariantsQueryParamFields]]
    r"""Fields to return"""
...
class ListCommerceItemvariantsRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListCommerceItemvariantsQueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListCommerceItemvariantsResponseTypedDict(TypedDict):
    content_type: str
...
class ListCommerceItemvariantsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
