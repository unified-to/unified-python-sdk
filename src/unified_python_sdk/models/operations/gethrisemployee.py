...
class GetHrisEmployeeQueryParamFields(str, Enum):
    ID = "id"
...
class GetHrisEmployeeRequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    id: str
    r"""ID of the Employee"""
    fields: NotRequired[List[GetHrisEmployeeQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class GetHrisEmployeeRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[GetHrisEmployeeQueryParamFields]],
...
class GetHrisEmployeeResponseTypedDict(TypedDict):
    content_type: str
...
class GetHrisEmployeeResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
