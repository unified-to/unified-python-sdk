...
class ListTicketingNotesQueryParamFields(str, Enum):
    ID = "id"
...
class ListTicketingNotesRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[ListTicketingNotesQueryParamFields]]
    r"""Fields to return"""
...
class ListTicketingNotesRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListTicketingNotesQueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
