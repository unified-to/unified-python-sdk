...
class CreateMetadataMetadataQueryParamFields(str, Enum):
    ID = "id"
...
class CreateMetadataMetadataRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreateMetadataMetadataQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreateMetadataMetadataRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateMetadataMetadataQueryParamFields]],
...
class CreateMetadataMetadataResponseTypedDict(TypedDict):
    content_type: str
...
class CreateMetadataMetadataResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
