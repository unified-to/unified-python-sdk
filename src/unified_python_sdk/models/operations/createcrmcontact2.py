...
class CreateCrmContact2QueryParamFields(str, Enum):
    ID = "id"
...
class CreateCrmContact2RequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreateCrmContact2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class CreateCrmContact2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateCrmContact2QueryParamFields]],
...
class CreateCrmContact2ResponseTypedDict(TypedDict):
    content_type: str
...
class CreateCrmContact2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
