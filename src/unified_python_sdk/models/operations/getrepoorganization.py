...
class GetRepoOrganizationQueryParamFields(str, Enum):
    ID = "id"
...
class GetRepoOrganizationRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[GetRepoOrganizationQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class GetRepoOrganizationRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[GetRepoOrganizationQueryParamFields]],
