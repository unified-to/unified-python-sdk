...
class ListAdsCampaigns2QueryParamFields(str, Enum):
    ID = "id"
...
class ListAdsCampaigns2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    end_lt: NotRequired[str]
    r"""The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)"""
    fields: NotRequired[List[ListAdsCampaigns2QueryParamFields]]
    r"""Fields to return"""
...
class ListAdsCampaigns2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListAdsCampaigns2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListAdsCampaigns2ResponseTypedDict(TypedDict):
    content_type: str
    ...
    ads_campaigns: NotRequired[List[shared_adscampaign.AdsCampaignTypedDict]]
    r"""Successful"""


class ListAdsCampaigns2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    ads_campaigns: Optional[List[shared_adscampaign.AdsCampaign]] = None
    r"""Successful"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["AdsCampaigns"])
        serialized = handler(self)
        m = {}
