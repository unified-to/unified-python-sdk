...
class ListMetadataMetadatasQueryParamFields(str, Enum):
    ID = "id"
...
class ListMetadataMetadatasRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[ListMetadataMetadatasQueryParamFields]]
    r"""Fields to return"""
...
class ListMetadataMetadatasRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListMetadataMetadatasQueryParamFields]],
