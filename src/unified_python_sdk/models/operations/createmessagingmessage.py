...
class CreateMessagingMessageQueryParamFields(str, Enum):
    ID = "id"
...
class CreateMessagingMessageRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[CreateMessagingMessageQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class CreateMessagingMessageRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateMessagingMessageQueryParamFields]],
