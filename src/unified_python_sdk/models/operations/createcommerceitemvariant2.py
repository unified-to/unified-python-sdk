...
class CreateCommerceItemvariant2QueryParamFields(str, Enum):
    ID = "id"
...
class CreateCommerceItemvariant2RequestTypedDict(TypedDict):
    commerce_itemvariant: shared_commerceitemvariant.CommerceItemvariantTypedDict
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[CreateCommerceItemvariant2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class CreateCommerceItemvariant2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateCommerceItemvariant2QueryParamFields]],
...
class CreateCommerceItemvariant2ResponseTypedDict(TypedDict):
    content_type: str
...
class CreateCommerceItemvariant2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
