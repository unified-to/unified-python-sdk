...
class PatchCommerceLocationQueryParamFields(str, Enum):
    ID = "id"
...
class PatchCommerceLocationRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[PatchCommerceLocationQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class PatchCommerceLocationRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[PatchCommerceLocationQueryParamFields]],
