...
class GetUnifiedIntegrationSamlRequestTypedDict(TypedDict):
...
class GetUnifiedIntegrationSamlRequest(BaseModel):
...
class GetUnifiedIntegrationSamlResponseTypedDict(TypedDict):
    content_type: str
...
class GetUnifiedIntegrationSamlResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
