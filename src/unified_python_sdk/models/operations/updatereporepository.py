...
class UpdateRepoRepositoryQueryParamFields(str, Enum):
    ID = "id"
...
class UpdateRepoRepositoryRequestTypedDict(TypedDict):
    ...
    fields: NotRequired[List[UpdateRepoRepositoryQueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
...
class UpdateRepoRepositoryRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[List[UpdateRepoRepositoryQueryParamFields]],
