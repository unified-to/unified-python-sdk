...
class ListAtsJobs2QueryParamFields(str, Enum):
    ID = "id"
...
class ListAtsJobs2RequestTypedDict(TypedDict):
    connection_id: str
    r"""ID of the connection"""
    company_id: NotRequired[str]
    r"""The company ID to filter by (reference to AtsCompany)"""
    fields: NotRequired[List[ListAtsJobs2QueryParamFields]]
    r"""Fields to return"""
...
class ListAtsJobs2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[ListAtsJobs2QueryParamFields]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Fields to return"""
...
class ListAtsJobs2ResponseTypedDict(TypedDict):
    content_type: str
...
class ListAtsJobs2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
