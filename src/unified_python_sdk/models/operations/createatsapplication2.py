...
class CreateAtsApplication2QueryParamFields(str, Enum):
    ID = "id"
...
class CreateAtsApplication2RequestTypedDict(TypedDict):
    ats_application: shared_atsapplication.AtsApplicationTypedDict
    connection_id: str
    r"""ID of the connection"""
    fields: NotRequired[List[CreateAtsApplication2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class CreateAtsApplication2Request(BaseModel):
    ...
    fields: Annotated[
        Optional[List[CreateAtsApplication2QueryParamFields]],
...
class CreateAtsApplication2ResponseTypedDict(TypedDict):
    content_type: str
...
class CreateAtsApplication2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["AtsApplication"])
        serialized = handler(self)
        m = {}
