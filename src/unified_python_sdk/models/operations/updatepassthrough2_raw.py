...
class UpdatePassthrough2RawRequestTypedDict(TypedDict):
    connection_id: str
...
class UpdatePassthrough2RawRequest(BaseModel):
...
class UpdatePassthrough2RawResponseTypedDict(TypedDict):
    content_type: str
...
class UpdatePassthrough2RawResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
