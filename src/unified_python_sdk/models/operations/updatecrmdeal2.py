...
class UpdateCrmDeal2QueryParamFields(str, Enum):
    ID = "id"
...
class UpdateCrmDeal2RequestTypedDict(TypedDict):
    ...
    id: str
    r"""ID of the Deal"""
    fields: NotRequired[List[UpdateCrmDeal2QueryParamFields]]
    r"""Fields to return"""
    raw: NotRequired[str]
    r"""Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&zoo=bar -> raw=foo%3Dbar%26zoo%3Dbar"""


class UpdateCrmDeal2Request(BaseModel):
    crm_deal: Annotated[
    ...
    fields: Annotated[
        Optional[List[UpdateCrmDeal2QueryParamFields]],
...
class UpdateCrmDeal2ResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateCrmDeal2Response(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
