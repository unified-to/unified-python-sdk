        ...
        *,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.storage_file, False, True, "json", Optional[shared.StorageFile]
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.CreateStorageFileResponse(
                storage_file=utils.unmarshal_json(
                    http_res.text, Optional[shared.StorageFile]
                ),
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.ListStorageFilesResponse(
                storage_files=utils.unmarshal_json(
                    http_res.text, Optional[List[shared.StorageFile]]
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
