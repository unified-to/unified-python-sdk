...
class Ads(BaseSDK):
    ...
    def create_ads_asset(
        self,
        *,
        request: Union[
            operations.CreateAdsAssetRequest, operations.CreateAdsAssetRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> operations.CreateAdsAssetResponse:
        r"""Create an asset
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.CreateAdsAssetRequest)
        request = cast(operations.CreateAdsAssetRequest, request)
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.ads_asset, False, False, "json", shared.AdsAsset
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.CreateAdsAssetResponse(
                ads_asset=unmarshal_json_response(Optional[shared.AdsAsset], http_res),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
            )
    ...
    async def create_ads_asset_async(
        self,
        *,
        request: Union[
            operations.CreateAdsAssetRequest, operations.CreateAdsAssetRequestTypedDict
    ...
    def get_ads_asset(
        ...
        *,
        request: Union[
            operations.GetAdsAssetRequest, operations.GetAdsAssetRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> operations.GetAdsAssetResponse:
        r"""Retrieve an asset
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetAdsAssetRequest)
        request = cast(operations.GetAdsAssetRequest, request)

        req = self._build_request(
            method="GET",
            path="/ads/{connection_id}/asset/{id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.GetAdsAssetResponse(
                ads_asset=unmarshal_json_response(Optional[shared.AdsAsset], http_res),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
    ...
    def list_ads_assets(
        ...
        *,
        request: Union[
            operations.ListAdsAssetsRequest, operations.ListAdsAssetsRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> operations.ListAdsAssetsResponse:
        r"""List all assets
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListAdsAssetsRequest)
        request = cast(operations.ListAdsAssetsRequest, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.ListAdsAssetsResponse(
                ads_assets=unmarshal_json_response(
                    Optional[List[shared.AdsAsset]], http_res
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
    ...
    async def list_ads_assets_async(
        self,
        *,
        request: Union[
            operations.ListAdsAssetsRequest, operations.ListAdsAssetsRequestTypedDict
