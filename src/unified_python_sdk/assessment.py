...
class Assessment(BaseSDK):
    def create_assessment_order(
        self,
        *,
        request: Union[
            operations.CreateAssessmentOrderRequest,
            operations.CreateAssessmentOrderRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> operations.CreateAssessmentOrderResponse:
        r"""Create an order
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.CreateAssessmentOrderRequest)
        request = cast(operations.CreateAssessmentOrderRequest, request)

        req = self._build_request(
            method="POST",
            path="/assessment/{connection_id}/order",
            base_url=base_url,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.CreateAssessmentOrderResponse(
    ...
    async def create_assessment_order_async(
        self,
        *,
        request: Union[
            operations.CreateAssessmentOrderRequest,
    ...
    def get_assessment_order(
        self,
        *,
        request: Union[
            operations.GetAssessmentOrderRequest,
            operations.GetAssessmentOrderRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> operations.GetAssessmentOrderResponse:
        r"""Retrieve an order
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetAssessmentOrderRequest)
        request = cast(operations.GetAssessmentOrderRequest, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.GetAssessmentOrderResponse(
                assessment_order=unmarshal_json_response(
                    Optional[shared.AssessmentOrder], http_res
                ),
                status_code=http_res.status_code,
    ...
    async def get_assessment_order_async(
        self,
        *,
        request: Union[
            operations.GetAssessmentOrderRequest,
